...
contract BotsUniverse is ERC721A, Ownable {
    ...
    string public baseURI = "https://ipfs.io/ipfs/bafybeigctl2b7awit25rb2bfsxthl7j6df3bqnoypk6jysdn4rcyyoj4cm/";
    string public baseExtension = ".json";
    bool public paused = true;   
    
    constructor() ERC721A("BotsUniverse", "BOTZ", MAX_MINTS, MAX_SUPPLY) {  
    }
    
    function MintFree(uint256 _mintAmount) public payable{
      require(_mintAmount > 0 || _mintAmount <= maxPerAddressFreeLimit, "Invalid mint amount");
