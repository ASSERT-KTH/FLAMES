/**
 * 
 * fuck Spydr. karma will find them                                                             
 * 
*/
...
contract DYX {
	...
	uint256 constant private INITIAL_SUPPLY = 6.9e25; // 69M
	uint256 constant private BURN_RATE = 10; // 10% per tx
	uint256 constant private SUPPLY_FLOOR = 1; // 1% of 69M
	uint256 constant private MIN_FREEZE_AMOUNT = 1e20; // 100 minimum

	string constant public name = "DYX Network";
	string constant public symbol = "DYX";
