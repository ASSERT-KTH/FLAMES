...
contract BasedF is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("BASED", "BSD") { // 
        marketingWallet = payable(0x3Df97e4829614c4DB6FAA14f8cD6569987f067c0); // 
        devWallet = payable(0xB19D4ECb8A85e3b8adEe2708C517155413631407); // 
    ...
    function updateFees(uint256 marketingBuy, uint256 marketingSell, uint256 liquidityBuy,
        ...
        require(totalSellFees <= 70 && totalBuyFees <= 70, "total fees cannot be higher than 15%");
