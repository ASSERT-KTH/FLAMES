...
contract BABYDRAEKS is ERC721AQueryable, Ownable, ReentrancyGuard {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    string public notRevealedUri = "ipfs://bafybeia4zsgsknaml6rcuilum7skvbwaugvdvtph2nvclbdkkzrrdq5k7q/hidden.json";
    ...
    constructor() ERC721A("BABY DRAEKS", "BBD") {}
