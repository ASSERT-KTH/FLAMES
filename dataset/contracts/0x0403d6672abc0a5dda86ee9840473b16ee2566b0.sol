...
//*********************************************************************//
//
//     __    _               ______           __     ____  _         __  __                       
//    / /   (_)   _____     / ____/___ ______/ /_   / __ \(_)__      \ \/ /___  __  ______  ____ _
//   / /   / / | / / _ \   / /_  / __ `/ ___/ __/  / / / / / _ \      \  / __ \/ / / / __ \/ __ `/
//  / /___/ /| |/ /  __/  / __/ / /_/ (__  ) /_   / /_/ / /  __/      / / /_/ / /_/ / / / / /_/ / 
// /_____/_/ |___/\___/  /_/    \__,_/____/\__/  /_____/_/\___/      /_/\____/\__,_/_/ /_/\__, /  
//                                                                                       /____/   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1fb8F9ebbea151e901Da055D44081853C09057FA,0x385B0709801baca31f0aB91EcacE4F16c439246F,0x8129785252F20420c5B981625Ae36869607FD12d];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 6400 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXFsgfxWwdxXtRL93WdNs6Erfx5X8tmavC9uY86VLEpkk/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 6400");
...
// File: contracts/LiveFastDieYoungContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LiveFastDieYoungContract is RamppERC721A {
    constructor() RamppERC721A("Live Fast Die Young ", "LFDY"){}
}
