/** 
    Sniping dapp for everyday Degens
    
    https://www.sharpshooter.info
    https://t.me/SharpShooter_Portal_ERC20/13
*/
...
contract SharpShooter is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x450d7DD1cac128dcfae57F6Ab1586f497bB2C828); // Marketing Address
    address payable public multiSigAddress = payable(0x7A243254Ba6f5b5559ffbE9791925C70aE644333); // Marketing Address
    address payable public devAddress = payable(0x801Af92aa3832F66E66FC0F0ED5fCc69514BC08E); // Dev Address
    address payable public liquidityAddress = payable(0xCf25F88bC15E166F5Eedcb43acFe13908Ee2C607); // Liquidity Address
    ...
    string private constant _name = "SharpShooter";
    string private constant _symbol = "BARRETT";
    ...
    uint256 public _buyMultiSigFee = 10;
    uint256 public _buyMarketingFee = 25;
    uint256 public _buyDevFee = 65;
