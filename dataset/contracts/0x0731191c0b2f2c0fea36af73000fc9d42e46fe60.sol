...
contract GLORBZ is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmZHokJYN1C3ASf6HvQhRzhxWqzPBrkFhTTwFHcYrd6wqu/";
    ...
    constructor(string memory initBaseURI) ERC721A("GLORBZ", "GZ") {
        baseURI = initBaseURI;
