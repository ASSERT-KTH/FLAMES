...
Sherlock $HOLMES is a proprietary in-house solution that allows you to play the detective in order to DYOR on TG users and groups. $HOLMES enables its holders to identify users history & groups they are apart of. Additionally, it enables you to identify scam or alpha groups by spying on others.

Website: https://HolmesToken.tech
Twitter: https://twitter.com/HolmesToken
Medium: https://medium.com/@HolmesToken
TG: https://t.me/HolmesToken
...
contract HOLMES is Context, IERC20, Ownable {
    ...
    string private constant _name =    unicode"Sherlock";
    string private constant _symbol =  unicode"HOLMES";
