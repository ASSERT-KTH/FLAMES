...
contract GameChannelConflict is GameChannelBase {
    ...
    * @param _balance User's balance.
    */
    function serverForceGameEnd(address _userAddress, uint _gameId, int _balance) public onlyServer {
        uint gameId = userGameId[_userAddress];
        Game storage game = gameIdGame[gameId];
        ...
        closeGame(game, gameId, game.roundId, _userAddress, ReasonEnded.SERVER_FORCED_END, _balance);
    }
