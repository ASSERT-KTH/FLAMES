...
contract BlackRabbitProjectToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Black Rabbit", "BRPT") {
        ...
        marketingWallet = address(0x2B9f3650729213DF0155f3FC3fFD735114b46B55); //
        devWallet = address(0x213504A2edfCa438B95280A90fb4588C2f01253c); // 
