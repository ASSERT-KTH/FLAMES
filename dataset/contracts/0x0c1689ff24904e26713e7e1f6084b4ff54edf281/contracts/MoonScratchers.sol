...
contract MoonScratchers is ERC721A, Ownable, ReentrancyGuard {

  using Strings for uint256;

  string public uriPrefix = '';
  string public uriSuffix = '.json';
  string public hiddenMetadataUri = 'ipfs://QmP5jr9kYV2AtRx3JHfPJ2R7Cg8utRYtxSHU8FWsj8TGdt/Hidden.json';
  ...
  constructor() ERC721A("MoonScratchers", "MS") {
  }
