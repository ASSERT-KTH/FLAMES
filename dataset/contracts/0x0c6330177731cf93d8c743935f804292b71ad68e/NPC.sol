 ...
 * @notice This contract handles minting NPC tokens.
 */
contract NPC is
    ERC721A,
    ERC721AQueryable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xCF226eC3C507bE7f8484e9D7E6cE7DE117eBb29E;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x3191669893A8470fDE1008185F3e0c1AD473bf5F;
    ...
    string public baseTokenURI =
        "ipfs://bafybeia6d2j2g2cygcl2opjjt3lso4omhoe52tecjdedcl2v3akhqpmdsq/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 1010;
    // Total number of tokens available for minting in the presale
    uint256 public PRESALE_MAX_SUPPLY = 505;
    // Fee paid to HeyMint per NFT minted
    uint256 public heymintFeePerToken;
    uint256 public presaleMintsAllowedPerAddress = 1;
    uint256 public presaleMintsAllowedPerTransaction = 1010;
    uint256 public presalePrice = 0 ether;
    uint256 public publicMintsAllowedPerAddress = 2;
    uint256 public publicMintsAllowedPerTransaction = 1010;
    uint256 public publicPrice = 0.00101 ether;
