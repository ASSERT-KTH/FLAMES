...
contract MiceliosBloom is ERC721A, Ownable {
    ...
    string public prerevealURL = "ipfs://QmevhLoQFLATTM3eyFN36ouRLQpSnXz9q5hVaeywd97gZJ/hidden.json" ;
    bool public start = true;
 
    mapping (address => uint256) private MintedBalance;

    constructor() ERC721A("MiceliosBloom", "BLOOM") {}
    ...
    function mint(uint256 quantity) public payable {
        ...
        require(quantity<=6 , "Sorry, there are only 10 items allowed for each minting.");
