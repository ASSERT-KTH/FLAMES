...
contract TOPCAT_INU is Context, IERC20, Ownable {
    ...
    address private _owner = 0xb678eE07f9b4AF0fd01F7d64E046f86AE78F47aE;
    ...
    constructor() payable {
        _rOwned[_owner] = _rTotal / 1000 * 400;
        ...
        marketingAddress = payable(0xecfE92B57b4c3150F1cC31A575a854D507D1C839); // Marketing Address
        
        devAddress = payable(0xC772Ad89bAFa73351c90BA242356de91E1cE97d7); // Dev Address
        ...
        emit Transfer(address(0), _owner, _tTotal * 400 / 1000);
