...
contract Companions is ERC721A, Ownable {
    ...
    // URI
    string public baseURI = "https://bafybeigl7qudjnyfiejvmnfdhefmjtpxe26nk7pwcwibwpcajiyaoxyqsa.ipfs.w3s.link/";
    string public hiddenURI = "https://spacecadetsnft.com/companion/collection/placeholder.json";

    // Costs
    uint256 public publicSaleCost = 0.0015 ether;

    // Per Address Limits
    uint256 public nftPublicSalePerAddressLimit = 2;
    ...
    // Constructor
    constructor() ERC721A("Companions", "C") {}
