/**
  ...
  _____ _  _ ___    ___ ___ ___   _ _____ _   _ ___ ___ ____
 |_   _| || | __|  / __| _ \ __| /_\_   _| | | | _ \ __|_  /
   | | | __ | _|  | (__|   / _| / _ \| | | |_| |   / _| / / 
   |_| |_||_|___|  \___|_|_\___/_/ \_\_|  \___/|_|_\___/___|
...
abstract contract Ownable is Context {
    ...
    contract TheCreaturez is ERC721A, Ownable {
    using Strings for uint256;
  ...
  constructor() ERC721A("The Creaturez", "999") {
  }
...
function whitelistMint(uint8 _mintAmount) external payable {
 ...
 function setRevealed() external onlyOwner{
  ...
  function _baseURI() internal view  override returns (string memory) {
    ...
    function setTERROR(uint8 _timer666) external onlyOwner{
