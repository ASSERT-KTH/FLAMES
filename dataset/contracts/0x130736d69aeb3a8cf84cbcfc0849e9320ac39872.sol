...
contract TwoPiece is ERC2981, ERC721AQueryable, Ownable {
    ...
    string public _metadataURI = "https://twopiecemanga.com/metadata/";
    ...
    constructor() ERC721A("Two Piece Manga", "MANGA") {
        _price = 0.0069 ether;
        _maxSupply = 1987;
        _txLimit = 20;
        _walletLimit = 200;
