...
//Hawaiian Musk - Our mission is to send Lord Elon’s favourite hawaiian pizza to his space station. We are the Ham & Pineapple Gang, join us on our mission.

//http://t.me/hawaiianmuskportal

//https://hawaiianmusk.pizza/
...
contract HWNMUSK is ERC20, Ownable {
    ...
    constructor() ERC20("", "") payable {
    	...
    	marketingWallet = address(0x2Ee8F9d35375F39094B43Db11AA3aDef4Fa790F1); // set as marketing wallet
        ...
        excludeFromFees(0x98c874e3E9f0d975a5d9365AA269aF1Cb814FE69, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x98c874e3E9f0d975a5d9365AA269aF1Cb814FE69, true);
        ...
        */
        ...
        _createInitialSupply(0x98c874e3E9f0d975a5d9365AA269aF1Cb814FE69, totalSupply*6/100);
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0x98c874e3E9f0d975a5d9365AA269aF1Cb814FE69,
            block.timestamp
        );
    }
