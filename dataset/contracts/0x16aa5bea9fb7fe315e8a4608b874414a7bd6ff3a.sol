...
contract TheGhostsQueen is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("The Ghosts Queen", "TGQ") {
        setHiddenMetadataUri("ipfs://QmNtZoaikh5MBzbp7zdaB5bHDR6cQe3LkiGkGt8SQfjzcy//");
        setBaseURI("ipfs://QmNtZoaikh5MBzbp7zdaB5bHDR6cQe3LkiGkGt8SQfjzcy//");
    }
    ...
    function mint(uint256 count) external payable {
      ...
      require(totalSupply() + count <= maxSupply, "No more TGQ");
