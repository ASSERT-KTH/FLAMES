...
// File: contracts/KitaroAnatomy.sol
...
contract KitaroAnatomy is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 3324;
  ...
  ) ERC721A("Kitaro Anatomy", "KITAROANATOMY") {
