...
contract BexterLife is ERC721A, Ownable {
    using Strings for uint256;
...
constructor() ERC721A("Bexter Life", "Bexter") {
        setHiddenMetadataUri("https://api.bexter.life/");
        setBaseURI("https://api.bexter.life/");
    }
    ...
    require(mintEnabled, "Mint not live yet");
      ...
      require(totalSupply() + count <= maxSupply, "No more Mania");
