...
contract EtherStake2 is StandardToken {
  string public constant name = "EtherStake2";
  string public constant symbol = "EST2";
  uint256 public constant decimals = 18;
  string public version = "1.0";

  uint256 public constant total = 5 * (10**7) * 10**decimals;   // 50 Million

  function EtherStake2() public {
