/**
    ...
    "The year is 2057.
    After years of fighting Covid-19, The Russian-Ukranian War, The Covid Z-22, The Great Canada Bay War, the world is in ruins.

    Those that are left, are fully infected with $BIOZ, the new virus that is leaving almost no one left to tell the story.
    Those that are worth it, wear a "Bioz Stamp" on their suits.

    They are safely located in the Biohazard Genesis Labs, where they are trained and equipped with the Bioz Plasma Gear to capture and redeem those that are still worthy to wear the "Bioz Stamp"!"

    Are you worthy to join The Biohazard Organization?
    
    Telegram: https://t.me/biohazardeth
    Twitter: https://twitter.com/biohazardeth
    Website: https://biozvirus.com
...
contract BioHazard is Context, IERC20, Ownable {
    ...
    string private constant _name = "BioHazard";
    string private constant _symbol = "BIOZ";
    ...
    constructor () {
        _feeAddrWallet = payable(0x323878132d33304c91153bc158E21e314492df4C);
