...
contract FaithInChivalry is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("Faith In Chivalry", "FCY") {
        setHiddenMetadataUri("ipfs://Qmf2WDsGJd3SM6oU3CXTDTaJqzh4QcRpa6hPJ3Vk67xCVv//");
        setBaseURI("ipfs://Qmf2WDsGJd3SM6oU3CXTDTaJqzh4QcRpa6hPJ3Vk67xCVv//");
    }
    ...
    function mint(uint256 count) external payable {
      ...
      require(totalSupply() + count <= maxSupply, "No more FCY");
