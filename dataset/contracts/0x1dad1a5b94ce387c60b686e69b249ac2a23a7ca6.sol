...
// File: contracts/HornyHorses.sol

pragma solidity ^0.8.0;

contract HornyHorses is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Horny Horses", "HHORSES") {
      ...
      payable
  {
    ...
    require( numberOfTokens <= FREE_MINTS_PER_TX ,"Maximum two minted per txn.");
