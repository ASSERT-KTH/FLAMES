...
contract TheVoyagersI is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("The Voyagers I: The Terminals", "VTERM"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Terminals...");
