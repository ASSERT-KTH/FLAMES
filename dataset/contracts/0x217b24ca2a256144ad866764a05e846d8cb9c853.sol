...
contract GOONYGOBLINS is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://goblingoonslair.com/goblin";
    ...
    constructor(
    ) ERC721A("GOONY GOBLINS", "GOBLINS", 100, maxSupply) {
    }
