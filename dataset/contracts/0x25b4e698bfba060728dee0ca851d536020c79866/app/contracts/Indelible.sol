    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"bottom", unicode"foreground", unicode"top", unicode"eyes", unicode"head", unicode"body"];
        ...
        uint public maxPerAllowList = 25;
        bool public isAllowListActive;
        
        ContractData public contractData = ContractData(unicode"Noun Peepos", unicode"Noun Peepos is a premier exhibition of 10,000 peepos peacefully existing on the Ethereum blockchain. The collection features original pixel art, by espress0.eth.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/a0da18dc-15f8-4d17-980b-aa9dafd4951b", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/a0da18dc-15f8-4d17-980b-aa9dafd4951b", "https://linktr.ee/NounPepes", 500, "0xaF2AB6D0e8F69656e7C8C967351DE32f0d60Fe76");

        constructor() ERC721A(unicode"Noun Peepos", unicode"NP") {
            TIERS[0] = [50,300,300,400,400,420,700,700,700,700,700,700,700,700,700,700,1129];
TIERS[1] = [100,100,100,100,500,1500,1500,1500,1500,1500,1599];
TIERS[2] = [50,50,50,50,50,50,50,100,100,100,100,100,100,100,100,100,100,100,100,100,100,150,150,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,249,500];
TIERS[3] = [500,1100,1100,1100,1100,1100,1999,2000];
TIERS[4] = [50,800,800,800,800,800,800,800,800,800,800,1949];
TIERS[5] = [50,800,800,800,800,800,800,800,800,800,800,1949];
            withdrawRecipients[0] = WithdrawRecipient(unicode"null",unicode"null", 0x41538872240Ef02D6eD9aC45cf4Ff864349D51ED, 5000);
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Noun Peepos #");
