...
contract TokyoN1z  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://bafybeiezuls2l2q4y5uo4jgwx2llxvoawa55t7ls7lgkilkqfdnwp3gxcy/";
    ...
    function TON1zMint(uint256 amount) public payable callerIsUser{
    ...
    function AirTON1z(address to, uint256 amount) external onlyOwner {
        require(totalSupply() + amount <= maxSupply, "Request exceeds collection size");
        _safeMint(to, amount);
    }

    function TON1zTeam(uint256 quantity) external payable onlyOwner {
