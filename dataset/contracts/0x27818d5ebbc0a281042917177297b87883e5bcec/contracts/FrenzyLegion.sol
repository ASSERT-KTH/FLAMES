...
contract FrenzyLegion is ERC721A, Ownable, ReentrancyGuard {

  using Strings for uint256;

  string public uriPrefix = 'ipfs://QmYPX4XM2RvsquZAmfKJeehBNA8yiBWeiS1uiYEtnKZoN7/';
  string public uriSuffix = '.json';
 
  uint256 public cost = 0.005 ether;
  uint256 public maxSupply = 666;
  uint256 public maxMintAmountPerTx = 20;
  uint256 public freeUntil = 200;
  uint256 public freebiesPerWallet = 1;
  mapping(address => uint256) public freebieMap;

  bool public paused = true;

  constructor() ERC721A("FrenzyLegion", "FrenzyLegion") {
  }
