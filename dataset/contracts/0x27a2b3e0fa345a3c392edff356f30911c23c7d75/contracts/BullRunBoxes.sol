   ...
   `-_---' `---_-'
    <__|o` 'o|__>
       \  `  /
        ...
        :o_o:
         "-"   THE BULL RUN HAS STARTED. WITH BOXES.
*/
...
contract BullRunBoxes is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  bool public revealedAirDrop = false;
