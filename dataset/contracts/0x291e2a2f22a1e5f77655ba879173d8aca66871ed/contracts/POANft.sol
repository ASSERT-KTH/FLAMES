...
contract POANFT is ERC721Enumerable, Ownable {
  ...
  constructor() ERC721("Prince of Arkria Official", "P.O.A") {
    mintGroups[0] = MintInfo("OG", 0 ether, 2, 1676464200, 1676464800);
    mintGroups[1] = MintInfo("WL", 0 ether, 1, 1676464800, 1676465400);
    mintGroups[2] = MintInfo("WL2", 0 ether, 1, 1676516400, 1676538000);
    mintGroups[3] = MintInfo("PB", 0 ether, 1, 1676538000, 1676559600);
  }
