...
contract MaybeOkayBears is ERC721A, Ownable{ 
    using Strings for uint256;
    ...
    constructor(uint256 price, uint256 maxSupply, string memory baseUri, uint256 freeMintLimitPerWallet, uint256 maxMintPerTX, bool isSaleActive, uint256 freeMintSupply) ERC721A("Maybe Okay Bears", "MAYBEOKAYBEARS"){
        PRICE = price;
