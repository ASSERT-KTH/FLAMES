...
// File: contracts/CyberCityCitizens.sol
...
contract CyberCityCitizens is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "";
  uint256  public  Max_Supply = 3030;
  uint256 public  Max_Per_TX = 10;
  uint256 public  Price = 0.001 ether;
  uint256 public  Num_Free_Mints = 1010;
  uint256 public  Max_Free_Per_Wallet = 2;
  bool public isMintActive = true;

  constructor(

  ) ERC721A("Cyber City Citizens 3030", "CCC") {
