...
contract PinkPunksNFT is ERC721A, Ownable {
    ...
    constructor() ERC721A("PinkPunksNFT", "PUNKS") {}
    ...
    function mint(uint256 quantity) public payable {
        ...
        require(quantity<=4 , "Sorry, there are only 10 items allowed for each minting.");
