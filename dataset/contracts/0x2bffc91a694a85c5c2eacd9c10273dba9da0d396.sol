...
// | ,__/'| |(`\/') /'__`\ | |    | ,__/'/'__`\| |  /',__)
// | |    | | >  < (  ___/ | |    | |   (  ___/| |_ \__, \
// (_)    (_)(_/\_)`\____)(___)   (_)   `\____)`\__)(____/
//                                                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xF3a6f6417CbB058DBf052471cDFFFa38EE3148Ce];
  address public erc20Payable = 0xF3a6f6417CbB058DBf052471cDFFFa38EE3148Ce;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 501;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiak7svuiarmf5tzbak3xqyakekuzsxpwmon5mq57pzfn4ewbhjp6i/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/itxLEjbaiDPclWMSxg73/contract-metadata";
  }
...
// File: contracts/PixelPetsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PixelPetsContract is RamppERC721A {
    constructor() RamppERC721A("Pixel Pets", "PP"){}
}
