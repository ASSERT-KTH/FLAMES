...
contract Holly is DefaultOperatorFilterer, ERC721A, Ownable, ReentrancyGuard {
    ...
    string public _baseURL = "ipfs://QmUpci831DwN4q5axz1kxHcDT8db45x5KyQbtx9bSKynjC/";
    string public prerevealURL = "";

    mapping(address => uint256) private _walletMintedCount;

    constructor() ERC721A("HollyDAO", "HOLLY") {}
    ...
    */
    ...
    function mint(uint256 count) external payable {
        ...
        require(count > 0, "Mint at least 1 Holly");
        require(minted < maxPerWallet, "Too many Hollys");
