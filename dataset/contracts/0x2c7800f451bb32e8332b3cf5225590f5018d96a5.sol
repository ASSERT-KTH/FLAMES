...
degenerate.tools is a Telegram bot with advance tools to aid
ERC-20 Defi trading. Features are unlocked through a tier system
determined by token holdings.

Smart Contract contains our own built-in MEV frontrun protection,
preventing MEV bots from frontrunning buys/sells.

Block 0-n snipers will have their tokens locked with 25% max supply
unlocking ~40 minutes after launch and 25% max supply each following hour.

- degenerate.tools team


Website:
https://degenerate.tools

Telegram:
https://t.me/degeneratetools
...
contract DEGENERATETOOLS is ERC20, Ownable {
    ...
    constructor() ERC20("degenerate.tools", "DTOOLS") {
