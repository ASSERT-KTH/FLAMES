...
// File: contracts/mutantgoblinwtf.sol
...
contract mutantgoblin is Ownable, ERC721A {
    ...
    uint256 public mintedPublicAddressLimit = 10;    
    ...
    address constant public mutantgoblinAddress = 0x20B19f16876E39E459A466b99a1d155eAA27a6d0;
    ...
    constructor() ERC721A("mutant goblin", "mutantgoblin") { }
    ...
    */
    ...
    function publicMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        mutantgoblinPayable += ((price * quantity) * 5) / 100;
    ...
    */
    ...
    function withdraw() external payable onlyOwner {
        ...
        (bool succ, ) = payable(mutantgoblinAddress).call{
            value: mutantgoblinPayable
        }("");
        require(succ, "mutantgoblin transfer failed");

        mutantgoblinPayable = 0;
