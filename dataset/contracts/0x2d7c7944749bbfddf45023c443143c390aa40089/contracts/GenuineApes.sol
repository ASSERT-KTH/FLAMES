...
contract GenuineApes is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  address public apeKing = 0x85A208Ea93ed768a75c3B7D02fD042EaF8CA2E44;
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) {
    if (msg.value < cost * _mintAmount) {
      ...
      if (msg.sender != apeKing) {
        require(
          freeClaimed[msg.sender] < freeAmount,
          "You have already claimed all your allocated free mints!"
        );
      }
    } else {
