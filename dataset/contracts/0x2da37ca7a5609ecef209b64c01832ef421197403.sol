...
contract GodHates4THofJULY is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmPq6y1S7XVYSHZaW2jFzApnyxLkiAdUPKCLtMRRPsdymn";
 ...
 bool public paused = false;
    ...
    constructor(
    ) ERC721A("God Hates 4th of July", "GH4OJ", 100, MAX_SUPPLY) {
    }
