...
contract HOA is ERC721Enumerable, Ownable {
    ...
    address public constant creatorAddress = 0x12673391A96EC59A7d2c56C555EAfe51a3C543cF;
    ...
    function isStatus() public view returns (uint256) {
        ...
        } else if(block.timestamp >= 1654441060 && block.timestamp < 1654441060 + 1 days) {
    ...
    function whitelistMint(uint256 _tokenAmount, bytes32[] memory _merkleProof) public payable saleIsOpen {
        ...
        require(_tokenAmount <= 10, "Max limit a wallet");
        require(ownWallet[msg.sender] + _tokenAmount <= 10, "Maxium is 10");
        require(total + _tokenAmount <= 7500, "Max limit");
    ...
    function mintItem(uint256 _tokenAmount) public payable saleIsOpen {
        ...
        uint256 total = totalToken();
        require(_tokenAmount <= 2, "Max limit a wallet");
    ...
    function giftMint(uint256 _tokenAmount) public onlyOwner saleIsOpen {
        uint256 total = totalToken();
        require(_tokenAmount <= 100, "Max limit a wallet");
        require(ownWallet[msg.sender] + _tokenAmount <= 100, "Maxium is 100");
        require(total + _tokenAmount <= MAX_ELEMENTS, "Max limit");
