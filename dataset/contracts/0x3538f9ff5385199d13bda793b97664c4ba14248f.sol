...
contract CHAOSCRITTERS is ERC721A, Owneable {

    string public baseURI = "ipfs://QmTqqtRxezDFLaDA1wSx4uuD51MUJhf2BqBFHAefNU5Fcz/";
    string public contractURI = "ipfs://QmdVtsTUGixvLaD31RbMeUKEyq4iXN8HRhLHc2NDy3RrQN";
    ...
    constructor() ERC721A("Chaos.Critters", "CHAOS") {}

    function PublicMint(uint256 _amount) external payable {
        address _caller = _msgSender();
        require(!paused, "Paused");
        require(max_supply >= totalSupply() + _amount, "No Moar Critters");
        require(_amount > 0, "No 0 mints");
        require(tx.origin == _caller, "Critters Eat Contracts");
...
//Future Use
        function createChaos(uint256[] memory tokenids) external onlyOwner {
