...
contract BALLSBALLSBALLS is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmdjTXBefC8LEvrYtE6RVHg1XPDaEPzKJJsd3WdoWPy9Z3";
 ...
 bool public paused = false;
    ...
    constructor(
    ) ERC721A("BALLS BALLS BALLS", "BBB", 100, MAX_SUPPLY) {
    }
