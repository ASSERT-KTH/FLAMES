...
contract Gembot is ERC20, Ownable {
    ...
    constructor() ERC20("Gembot", "GEM") {
        ...
        revShareWallet = address(0x6A998E85a9Fc4AEe7640289A93439b38BEd8dd70); // set as revShare wallet
    ...
    function withdrawStuckGembot() external onlyOwner {
