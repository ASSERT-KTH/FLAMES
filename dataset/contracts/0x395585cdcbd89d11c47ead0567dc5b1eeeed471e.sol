...
contract CYNNFT is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    address public coldWallet = 0x0971AF56814a12127962DfDbf71877a60bE7b3A0; 

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("CYN NFT", "CYNNFT") {
        _safeMint(msg.sender, 10);
        setBaseURI("https://gateway.pinata.cloud/ipfs/QmVLDPbtkaVNiwc6dtWSMokovQWZrKHhQj1yPQv3AWSTYV/CYN.json");
    }
    ...
    /// @notice only owner can withdraw the money
     function withdrawMoney() external onlyOwner nonReentrant {
        (bool success, ) = coldWallet.call{value: address(this).balance}("");
