...
contract MAPE is ERC721A, Ownable, ReentrancyGuard, ERC2981 { 
...
uint256 public devTotal;
    ...
    uint256 public _maxFreeMintSupply = 99;
     uint256 public devSupply = 25;
    ...
    constructor(string memory initBaseURI) ERC721A("MonalisApe", "MAPE") {
        baseURI = initBaseURI;
