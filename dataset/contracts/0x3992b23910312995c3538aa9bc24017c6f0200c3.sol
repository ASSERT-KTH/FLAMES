...
contract LazyGoblinzNFT is ERC721A, Ownable {
	...
	function mint(uint count) external payable {
        ...
        if(_totalMinted()>9000){
            require(msg.value >= count * 0.01 ether,"Ether value sent is not sufficient");
        } else {
            uint countFree = 0;
