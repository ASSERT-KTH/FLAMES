...
contract BattleCattle is ERC721A, Ownable {
    using Strings for uint256;

    // Supply
    uint256 public maxSupply = 1000;
    uint256 public maxSupplyLimit = 50;
    ...
    // Per Address Limits
    uint256 public nftWhitelistSalePerAddressLimit = 12;
    ...
    // Constructor
    constructor() ERC721A("BattleCattle", "BC") {}
    ...
    modifier whitelistSaleMintCompliance(uint256 _mintAmount) {
        ...
        require(totalSupply() + _mintAmount <= maxSupplyLimit, "MSG: Max supply exceeded");
        _;
    }
