...
contract DeadHeadsWTF is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("deadheads.wtf", "deadheads.wtf"){
  }
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more dead headz");
