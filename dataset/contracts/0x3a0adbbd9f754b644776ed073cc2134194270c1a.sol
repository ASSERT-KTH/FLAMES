...
contract EpoX is IERC721A { 
    ...
    uint256 public constant MAX_FREE = 770;
    uint256 public constant MAX_FREE_PER_WALLET = 1;
    uint256 public constant COST = 0.0025 ether;

    string private constant _name = "EpoX";
    string private constant _symbol = "EPOX";
    string private _contractURI = "QmbXE5RF7yTywRtYzG9aYEhfcAq9Ju6kwG3PoA6hZFLTv8";
    string private _baseURI = "QmeDN31Seq8sKA6LcXu8SzwcqVrcYMuBLrBLr6Pz9cnZx5";
