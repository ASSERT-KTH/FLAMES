...
contract FreeBirds is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Free Birds", "FreeBirds"){}
  ...
  {
    uint cost = price;
    require(msg.sender == tx.origin,"Be yourself, bird.");
