...
contract LiquidityPool {
    ...
    constructor() public {
        ...
        previousContract = PreviousLiquidityContract(0x5CECDbdfB96463045b07d07aAa4fc2F1316F7e47);
        ...
        pampToken.approve(address(uniswapV2), 100000000000E18);
    }
    ...
    function migrateState() external {
        ...
        (uint startTimestamp, uint poolTokenBalance) = previousContract.getStaker(msg.sender);      // Get previous contract balance and info
