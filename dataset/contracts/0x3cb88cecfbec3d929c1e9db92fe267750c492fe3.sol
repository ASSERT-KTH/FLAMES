...
contract ShrimpTempura is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable private mktg = payable(0x41D081c9DDE1352A228A6EC2AD0dA334ce94fb71);
    address payable private dev = payable (0x251d2a25DbA9f88300c7664f907A268ce38351eb);
    ...
    constructor() ERC20("Shrimp Tempura", unicode"🍤") {
