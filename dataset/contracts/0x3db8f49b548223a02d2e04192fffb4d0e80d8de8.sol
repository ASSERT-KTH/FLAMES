...
contract petals is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmeRPV44xSgp6C6Q91oqJ33wJbo2HpmbzHy84bHucn7QmB";
    ...
    constructor(
    ) ERC721A("dynasty petals by cube", "petals", 100, maxSupply) {
    }
