...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xf560A2eb3C3B0Ca824eEE9eeBED8523560A1b4dc];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmZafx9r5DwSB4yFr8HhoHJqhGWYXamWsSvq1UKkYb1ABX/";
...
// File: contracts/M00NboysNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract M00NboysNftContract is RamppERC721A {
    constructor() RamppERC721A("m00nboys NFT", "m00n"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Alhcs3vffoBKDUnjqNcx/contract-metadata";
    }
}
