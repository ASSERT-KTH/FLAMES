...
contract SpookyApeHauntedClub is ERC721A, Ownable {
    
    uint256 MAX_SUPPLY = 10000;
    uint256 Allremain = 10000;
    uint256 public mintRate = 0.0035 ether; 
    uint256 MintForWallet = 10000;
    string public base_URI = "";
    string public baseExtension = ".json";
    string public prerevealURL = "ipfs://__CID__/" ;
    bool public start = true;
 
    mapping (address => uint256) private MintedBalance;

    constructor() ERC721A("Spooky Ape Haunted Club", "SAHC") {}
