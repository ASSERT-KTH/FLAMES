...
contract Hojutsu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "KNO3";
    ...
    uint256 private _teamFee = 3; // 2% Teh Research and 1% Teh War (Laika Marketing)
    ...
    function sendETHToFee(uint256 amount) private {
        _Marketingfund.transfer(amount.div(3).mul(1));
        _Buyback.transfer(amount.div(3).mul(2));
    }
