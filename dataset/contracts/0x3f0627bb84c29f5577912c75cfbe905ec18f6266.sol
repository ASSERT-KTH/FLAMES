...
contract EyesonTheOtherside  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://bafybeigbff65s5jphp7vhwkl7x55rcumsmvv5ef36wnnhyhnik2uk7zpym/";

    uint256 public immutable mintPrice = 0.001 ether;
    uint32 public immutable maxSupply = 1050;
    ...
    constructor()
    ERC721A ("Eyes on the otherside", "EOTO") {
    }
