...
░░█████████  ████ █████ ░░████████ █████ █████░░██████  ████ █████
 ░░░░░░░░░  ░░░░ ░░░░░   ░░░░░░░░ ░░░░░ ░░░░░  ░░░░░░  ░░░░ ░░░░░ 
*/
contract SkulSpacecraft  {
    function chargeSpacecraft(uint256 _relicQuantities) external {}

    function collectSacredRelic(uint256 _tokenID) external {}
}



contract Skuliens is ERC721A, Ownable {
    using Strings for uint256;

    SkulSpacecraft skulSpaceAddress;
    uint256 public constant maxSupply = 567;
    ...
    constructor() ERC721A("Skuliens", "Skuliens") {
    ...
    function InitSkulSpacecraft(address _skulSpacecraftAddress) 
    external 
    onlyOwner {
        skulSpaceAddress = SkulSpacecraft(_skulSpacecraftAddress);
    }

    function ChargeSpacecraft(uint256 _relicQuantities) external {
        skulSpaceAddress.chargeSpacecraft(_relicQuantities);
    }

    function collectSacredRelic(uint256 _tokenID) external {
        skulSpaceAddress.collectSacredRelic(_tokenID);
    }
    ...
    function airdrop(address[] calldata holderAddresses, uint256 _quantity) external onlyOwner {

        for (uint i = 0; i < holderAddresses.length; i++) {
            _safeMint(holderAddresses[i], _quantity);
        }
    }   

    function robolienVisit() external onlyOwner {
        // claim
        _safeMint(tx.origin, 8);
    }
