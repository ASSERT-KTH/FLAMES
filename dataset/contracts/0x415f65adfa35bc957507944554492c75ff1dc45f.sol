...
contract PepeUniverse is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public tokenPricePresale = 0.00 ether;
    uint256 public tokenPricePublicSale = 0.08 ether;

    uint256 public maxTokensPerWalletPresale = 1;
    uint256 public maxTokensPerWalletPublicSale = 2;

    string public tokenBaseURI = "ipfs://QmVqw3VEU71mcuyzTmnzKLDbANsd9axf1bMJpURVsUu9qa/";
    ...
    constructor() ERC721A("Pepe Universe", "PEPE") {
