...
contract FLAZUKI is ERC721A, Ownable {
    uint16 public constant MAX_SUPPLY = 10000;
    uint8 public constant MAX_PER_TX = 50;

    string private baseUri = "https://gateway.pinata.cloud/ipfs/QmesvMzgr98qCfSbyvbH1FmQEHvWty63E5NNpdG3PTZSF8/";
    uint96 private royaltyBasisPoints = 1000;

    constructor() ERC721A("Flazuki", "FLAZUKI") {}
    ...
    function mint(uint256 _quantity) external {
        ...
        require(_quantity <= MAX_PER_TX, "INCORRECT_QUANTITY");
