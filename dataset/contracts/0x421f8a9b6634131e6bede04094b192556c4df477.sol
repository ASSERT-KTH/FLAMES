...
contract ShittyGnomes is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("ShittyGnomes", "SGS"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(msg.sender == tx.origin,"Gnomes..but we're shitty");
    require(msg.value == amt * cost,"Please send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"SHIT, not enough anon.");
