...
contract MetaCriminals is ERC721A, Ownable {
    ...
    string public unrevealedTokenURI =
        "https://gateway.pinata.cloud/ipfs/Qmcu7hiuR61THuDU6L4KXuV6oDm5g5yS7REdhwmdAmaKTF";
    string public baseURI = "";

    mapping(uint256 => string) private _tokenURIs;

    address private _ownerWallet = 0xe63554B6DddC803989dA3649F6F85d45411524a9;

    constructor( ) ERC721A("metacriminalswtf", "METACRIMINAL") {
    }
