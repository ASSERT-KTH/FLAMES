...
contract SPACETAMA is Context, IERC20, ERC20Ownable {
    ...
    string private constant _name = "SPACETAMA";
    string private constant _symbol = "SPACETAMA";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x7A9F0174b1DbE59C3c979De15d7Ee5d1eacA724a);
        DevWallet = payable(0xcccB2cADeCF73f51f58DA6B6D715cB7b572FaBb8);
