 ...
 * @notice This contract handles minting HeyMint Launchpad ZA Access Pass tokens.
 */
contract LaunchpadHeyMintLaunchpadZAAccessPass is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x327d48456D4FaF70C31f5227e9f95638D7612811;
    ...
    uint256 public constant PRESALE_MAX_SUPPLY = 8000;
    uint256 public presaleMintsAllowedPerAddress = 1;
    uint256 public presaleMintsAllowedPerTransaction = 8000;
    uint256 public presalePrice = 0 ether;
    uint256[] public payoutPercentages = [100];
    uint96 public royaltyFee = 0;

    constructor() ERC721A("HeyMint Launchpad ZA Access Pass", "ZAHMAP") {
