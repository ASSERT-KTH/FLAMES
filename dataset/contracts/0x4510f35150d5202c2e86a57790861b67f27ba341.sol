...
contract MutantNotOkayBears is ERC721A, Ownable {
    ...
    constructor(uint256 maxTokens_, bool saleEnabled_, bool freeMintEnabled_, string memory baseURI_, uint256 maxMintForUser_, uint256 maxFreeMints_, uint256 price_) ERC721A("Mutant Not Okay Bears","Mutant Bear") {
