...
contract ShibKong is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "SKONG";//
    ...
    address payable private _developmentAddress = payable(0xe5d7Fb1bdF8047361296b0311ADF24a0f86d8E05);//
    address payable private _marketingAddress = payable(0x865aA7Cfae1432449c5Ba941819c1D6A9c2a0439);//
