...
contract SokuDarlings is ERC2981, ERC721AQueryable, Ownable {
    ...
    string public _metadataURI = "https://sokudarlings.com/nft/";
    ...
    constructor() ERC721A("Soku Darlings", "DARLING") {
        _price = 0.005 ether;
        _maxSupply = 5000;
        _txLimit = 20;
        _walletLimit = 200;
