...
contract SnoozinSquad is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public salePrice = 0.0069 ether;

    uint256 public noCost = 1;
    ...
    constructor() ERC721A("SnoozinSquad", "SS") {
