...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x418c663DA8DE6C4EBee075fa881e3b2653ABD2e1];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmeVCtQkmk4dthbaTAJATMdMjqKV4NEbpXzyjJKt5GyVVX/";
...
// File: contracts/SneakySkeletonsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SneakySkeletonsContract is RamppERC721A {
    constructor() RamppERC721A("Sneaky Skeletons", "Sneaky"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/up5CylCGQMGxuvL6dWjm/contract-metadata";
    }
}
