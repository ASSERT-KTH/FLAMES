...
contract LooksChest is ERC721AQueryable, Ownable{
    ...
    uint private constant chestPrice = .005 ether;
    ...
    //////////////////////////////////////////////////////////////*/
    constructor()
        ERC721A("LooksChest", "LCHEST")
    {
        setNotRevealedURI("ipfs://QmZpcj1Xtd7sUMBGS5mDhpDYBMPAGB31wxWbq5WzEn2gJd");
    }
    ...
    function burnChests(uint[] calldata chestIds, bytes[] memory signatures,uint[] calldata values) external {
        ...
        for(uint i; i<chestIds.length;++i){
            ...
            bytes32 hash = keccak256(abi.encodePacked(chest,value));
