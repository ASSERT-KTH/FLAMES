...
// SPDX-License-Identifier: AntNetwork

/**
 * @author  AntNetwork
 *
 * @dev     Contract for AntNetwork token with burn support
 */
...
// AntNetwork erc20 Token Contract.
contract AntNetworkToken is DeligateERC20, Ownable {
    uint256 private constant maxSupply = 21000 * 1e18;     // the total supply
    ...
    constructor() public ERC20("AntNetwork", "ANT") {}
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "AntNetwork: _addMinter is the zero address");

        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "AntNetwork: _delMinter is the zero address");
    ...
    modifier onlyMinter() {
        require(isMinter(msg.sender), "AntNetwork: caller is not the minter");
        _;
    }
}