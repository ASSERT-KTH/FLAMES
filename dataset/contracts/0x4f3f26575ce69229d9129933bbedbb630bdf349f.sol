...
contract Evilbook is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("Evilbook", "EB") {
        setHiddenMetadataUri("ipfs://QmW5f1V7Mo57GgE7oYBevQoUMVVwtzyYAVTRmkmMSBziXQ//");
        setBaseURI("ipfs://QmW5f1V7Mo57GgE7oYBevQoUMVVwtzyYAVTRmkmMSBziXQ//");
    }
    ...
    function mint(uint256 count) external payable {
      ...
      require(totalSupply() + count <= maxSupply, "No more EB");
