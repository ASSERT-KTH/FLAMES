...
contract AcidTrip is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Acid Trip", "ACID"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Acid...");
