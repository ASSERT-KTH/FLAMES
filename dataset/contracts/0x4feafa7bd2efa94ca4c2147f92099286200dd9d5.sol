...
//   / /|_/ / ___/ / /  / / / / //_/ / ___/                                                                   
//  / /  / / /__  / /__/ /_/ / ,< / (__  )                                                                    
// /_/ _/_/\___/ /____/\__,_/_/|_/_/____/                            __                 _       __            
//    / __ )____ ______/ /__   / /_____     ____  __  _______   ____/ /___ ___  __     (_)___  / /_  _____    
//   / __  / __ `/ ___/ //_/  / __/ __ \   / __ \/ / / / ___/  / __  / __ `/ / / /    / / __ \/ __ \/ ___/    
//  / /_/ / /_/ / /__/ ,<    / /_/ /_/ /  / /_/ / /_/ / /     / /_/ / /_/ / /_/ /    / / /_/ / /_/ (__  ) _ _ 
// /_____/\__,_/\___/_/|_|   \__/\____/   \____/\__,_/_/      \__,_/\__,_/\__, /  __/ /\____/_.___/____(_|_|_)
//                                                                       /____/  /___/                        
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x47Fa3297dE507970e7223111d46dFB6c8E015344,0xb6caf8A0fd8F59139F862664e8AB835B21437a5C,0x5c6FA2CE2D45C142F3Cc32b9EC82963773d50713];
  uint256[] public payableFees = [5,30,30,35];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 696 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmZbaG3U7jEFR1Mrdr4tGoKUy4569hNgoYpTmjnNFEpHao/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 696");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 696");
...
// File: contracts/McZukisContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract McZukisContract is RamppERC721A {
    constructor() RamppERC721A("McZukis", "MCZUKIS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ktApNkkhsDVYthyKJnS8/contract-metadata";
    }
}