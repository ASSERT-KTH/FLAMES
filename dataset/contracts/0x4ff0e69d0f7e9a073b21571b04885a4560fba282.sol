...
contract Kevinapes is ERC721A, Ownable {

    uint256 constant public maxSupply = 1000;
    uint256 public freeSupply = 0;
    uint256 constant public mintPrice = 0.0088 ether;
    uint256 constant public maxMint = 20;

    bool public isSaleLive = true;
    string public baseURI = "ipfs://QmabPh5Hh5U9Fp8Xi97T46Gx2v2sg2rNMpdF19ByAvhx3t/";

    constructor() ERC721A("Kevinapes", "KAPES") {}
