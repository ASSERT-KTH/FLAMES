...
contract AI510Liens is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmNLvjGaPrS3vm7Hwnw5MMxh47BQsKihKnEgsCyW2jtWT8/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  
  uint256 public cost = 0.005 ether;
  uint256 public maxSupply = 510;
  ...
  constructor() ERC721("AI510Liens", "A510L") {
    setHiddenMetadataUri("ipfs://QmNLvjGaPrS3vm7Hwnw5MMxh47BQsKihKnEgsCyW2jtWT8/");
  }
