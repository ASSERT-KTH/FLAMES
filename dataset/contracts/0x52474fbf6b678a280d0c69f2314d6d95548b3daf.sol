...
// Pettametti, art project by artist Pumpametti, 300 pettamettis for the 300 Pumpamettis, every Pumpa will get a Petta.
// Pumpametti holder get lifetime free mint for my projects, of course that includes the Pettametti!
// Go to MettiMint if you have one OG metti or MettiMultiMint if you have more than one OG mettis, 
...
// There'll only be 300 Pettamettis.
...
contract Pettametti is ERC721Enumerable, Ownable, RandomlyAssigned {
  using Strings for uint256;
