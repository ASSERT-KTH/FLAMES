/*
Welcome to Where Is Willy? 

The Ultimate Search Game! ❤️
*/
...
contract Token is ERC20, ERC20Burnable, Ownable, Initializable {
    ...
    {
        address supplyRecipient = 0x702212f16aB9207812335fB8E65Af7B7ACACd497;
        
        updateSwapThreshold(50000 * (10 ** decimals()) / 10);

        marketingAddressSetup(0x702212f16aB9207812335fB8E65Af7B7ACACd497);
        ...
        updateMaxWalletAmount(2000000 * (10 ** decimals()) / 10);

        _mint(supplyRecipient, 100000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x702212f16aB9207812335fB8E65Af7B7ACACd497);
    }
