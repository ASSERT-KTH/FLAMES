...
contract EmergedBulls is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    (bool artistSuccess, ) = payable(0x1b878bfA0508B6C584a10fEb60FacE7134BE60c9).call{value: artistPayment}('');
    require(artistSuccess);

    (bool marketerSuccess, ) = payable(0x6FefC205187644CC6Fb9541b0c87Fc44f014b70c).call{value: marketerPayment}('');
