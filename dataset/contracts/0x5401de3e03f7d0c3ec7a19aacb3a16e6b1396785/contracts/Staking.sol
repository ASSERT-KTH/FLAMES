...
contract Staking is IStaking, Ownable, Pausable, IERC721Receiver {
    ...
    IIslandToken public islandToken = IIslandToken(0x98A4f2fE63aC008AE14e1585931FC73AD90E9168); // ERC20

    bool private hasAirdroppedNftContract;
    ...
    /*
     * airdrops tokens for the bridge
     */
    function airdropNFTContract() external {
      if (!hasAirdroppedNftContract) {
        islandToken.mint(address(nftIslands), 170 * 5000 ether);
        hasAirdroppedNftContract = true;
      }
    }
