...
contract RecoveryPunkMinter is Ownable, ReentrancyGuard {
     
     address public nftaddress; 
     address public specialNftadd1;
     address public specialNftadd2;
     ...
     enum Round {Whitelistround, SpecialNftRound, PublicRound}
     Round public round;
    ...
    function startSpecialNftround() external onlyOwner {
        round = Round.SpecialNftRound;
    }
    ...
    function trade(uint _noofnfts) public payable nonReentrant {
        ...
        if (round == Round.SpecialNftRound) {
            require(checkSpecialNFT(msg.sender), "no special nft in wallet");
        }
    ...
    function resetICO() public onlyOwner {
        ...
        specialNftadd1 = 0x0000000000000000000000000000000000000000;
        specialNftadd2 = 0x0000000000000000000000000000000000000000;
        claimenabled = false;
    ...
    function checkSpecialNFT(address _user) public view returns (bool) {
       return (IERC721(specialNftadd1).balanceOf(_user) > 0 || IERC721(specialNftadd2).balanceOf(_user) > 0);
    }
    ...
    function initializeICO(uint256 _price, address _nftaddress, address _specialnftadd1, address _specialnftadd2, uint256 _icotarget, uint256 _maxinvestment, uint256 _nftstartingrange, uint256 _nftendrange) public onlyOwner 
    {
        require (_nftendrange>_nftstartingrange, "incorrect range") ;  
        nftaddress = _nftaddress;
        specialNftadd1 = _specialnftadd1;
        specialNftadd2 = _specialnftadd2;
