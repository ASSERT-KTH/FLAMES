...
contract Shamanistic is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://bafybeihsomoz2e7bvldgmf7smhx7lsjgbyzeqk3y44gkck6rpr7glucmca/";
    ...
    uint256 public constant FREE_MINT_SUPPLY = 900;
    uint256 public INSTANT_FREE_MINTED = 0;

    event Minted(address minter, uint256 amount);

    constructor(string memory initBaseURI) ERC721A("Shamanistic", "MASK") {
        baseURI = initBaseURI;
