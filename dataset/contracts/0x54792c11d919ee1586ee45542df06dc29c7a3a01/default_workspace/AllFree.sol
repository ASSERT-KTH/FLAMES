...
contract Global1984 is ERC721A,Ownable,ReentrancyGuard {
    using Strings for uint256;

    
    uint256 public maxSupply = 2469;
    uint256 public maxMint = 5;

    string public _baseTokenURI;
    string public _baseTokenEXT;
    string public notRevealedUri = "ipfs://QmTTbZtHBY1n4fkrkt8Sh9tmoMxES8W3z9fbLmkMdBKfNt/";
    ...
    constructor() ERC721A("1984 Global","1984") {}
