...
contract ERC721Mintable is ERC721, MinterRole {
    ...
    function mintLand(address to,uint256 OVRLandID) public onlyMinter returns(bool) {
       _mint(to,OVRLandID);
       return true;
    }
...
// File: contracts/OVRLand.sol

pragma solidity ^0.5.0;
 
contract OVRLand is ERC721Full, ERC721Mintable {

    constructor() ERC721Full("OVR Land", "OVRLand") public {
    }
