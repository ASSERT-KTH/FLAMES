...
contract WorldExploration is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmSmNSqK9AzP3fRR5bH3avK1mcWhMTcZZ6xZ8goTxVDy2Y";
    ...
    constructor(
    ) ERC721A("World Exploration by Mara Drozdova", "EXPLR", 100, maxSupply) {
    }
