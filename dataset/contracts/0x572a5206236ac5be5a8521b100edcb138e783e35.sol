...
contract BullShitters is ERC721A, Ownable {
    using Strings for uint256;
...
constructor() ERC721A("Bullshitters.lol", "Shitters") {
        setHiddenMetadataUri("https://api.bullshitters.lol/");
        setBaseURI("https://api.bullshitters.lol/");
    }
    ...
    require(mintEnabled, "Mint not live yet");
      ...
      require(totalSupply() + count <= maxSupply, "No more Shit");
    ...
    function MintShitWL(address to, uint256 quantity)public onlyOwner{
