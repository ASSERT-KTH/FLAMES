...
contract Mylifeisruinedbydna is ERC721A, DefaultOperatorFilterer {
    string public baseURI = "ipfs://bafybeifb2ubhk5pvm4yq33jghkyqgquhbwe2lfcjqjry7vtaqrpuknizhe/";      
    ...
    constructor() ERC721A("My life is ruined by dna", "MLIRBD") {
        owner = msg.sender;
    }
    ...
    function getFreeNum() internal returns (uint256){
        return (maxSupply - totalSupply()) / 20;
    }
