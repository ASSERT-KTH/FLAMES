...
contract NFT is ERC721A, Ownable, ReentrancyGuard {
  ...
  */
  ...
  function _baseURI() override internal pure returns (string memory) {
    return "https://mw9spidhbc.execute-api.us-east-1.amazonaws.com/dev/token/neekolul-dao/";
  }
  function contractURI() public pure returns (string memory) {
    return "https://mw9spidhbc.execute-api.us-east-1.amazonaws.com/dev/contract/neekolul-dao";
  }
}