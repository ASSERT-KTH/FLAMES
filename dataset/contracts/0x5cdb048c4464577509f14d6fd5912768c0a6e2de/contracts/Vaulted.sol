...
TWITTER: https://x.com/vaultedfinance
WEBSITE: https://vaulted.finance/ 
DAPP: https://dapp.vaulted.finance/ 
TG: https://t.me/VaultedChat

THE SAFE AND SIMPLE LIQUIDITY LOCKER WITH REV SHARE ON ALL SERVICE FEES.
...
contract VAULTED is ERC20("Vaulted Finance", "VAULTED"), Ownable {
    ...
    function getFees() internal {
        ...
        uint256 lastTierTwoBlock = tradingOpenedOnBlock + 12;
