...
//
// https://twitter.com/officialdegen23
// https://t.me/degen2023
//
...
contract D23 is ERC20, Ownable {
    ...
    constructor() ERC20("Degen 23", "D23") {
        ...
        maxTransactionAmount = totalSupply * 10 / 1000; // 1.0% maxTransactionAmount
        maxWallet = totalSupply * 15 / 1000; // 1.5% maxWallet
        swapTokensAtAmount = totalSupply * 5 / 10000; // 0.05% swap swapTokensAtAmount
