...
contract UndeadApeYachtClub is Ownable, ERC721A, DefaultOperatorFilterer  {
    ...
    uint64 public publicMaxSupply = 3777;
    uint64 public publicTotalSupply = 0;
    uint64 public presaleMaxSupply = 4000;
    uint64 public presaleTotalSupply = 0;

    uint64 public maxMintAmountPerPresaleAccount = 1;
    uint64 public maxMintAmountPerPublicAccount = 3;
    ...
    constructor() ERC721A("Undead Ape Yacht Club", "UAYC"){}
