...
// File: contracts/GenuineGigaChadOfficial.sol
...
contract GenuineGigaChadOfficial is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmfVJ6ZAkENymQoxVbGtQXhtSk3U1n6mMiSoKvDs5wFquv";
    ...
    constructor(string memory initBaseURI) ERC721A("Genuine GigaChad Official ", "GIGAO") {
        baseURI = initBaseURI;
