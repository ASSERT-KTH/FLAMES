...
contract TrippinFairy is ERC721A, Ownable {
    using Strings for uint256;
...
constructor() ERC721A("Trippin Fairy", "FAIRY") {
        setHiddenMetadataUri("https://api.ptrippinfairy.xyz/");
        setBaseURI("https://api.trippinfairy.xyz /");
    }
    ...
    require(mintEnabled, "Mint not live yet");
      ...
      require(totalSupply() + count <= maxSupply, "No more Fairy");
    ...
    function MintWL(address to, uint256 quantity)public onlyOwner{
