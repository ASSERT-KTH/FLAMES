/**************************************************
    ...
    Bot:        https://t.me/blazeaiBot
    Website:    https://blazeai.tech
    Docs:       https://blazeai-bots-documentation.gitbook.io/blazeai-bot-documentation
...
contract BlazeAIToken is ERC20, Ownable {
    ...
    constructor() ERC20("Blaze AI", "BLAI") {
        ...
        blazeAIWallet = 0x8dc965B8A15d70Ca998fdEBfc8BD502bC14aa3E3;
        _liquidityProviderWallet = 0x443634DcD7543AB0Bf11Bd3f0ee8aaBF79e8549A; //redemitdaoinvestments.eth
        address airdropWallet = 0xE36eA40a963fE92cA184bC1F17AcCc0da2E60862;

        _isExcludedFromMaxWalletLimit[owner()] = true;
        _isExcludedFromMaxWalletLimit[address(this)] = true;
        _isExcludedFromMaxWalletLimit[address(0xdead)] = true;
        _isExcludedFromMaxWalletLimit[blazeAIWallet] = true;
        ...
        _isExcludedFromFees[blazeAIWallet] = true;
        ...
        _mint(airdropWallet, (_totalSupply * 8) / 100);
        _mint(_liquidityProviderWallet, (_totalSupply * 92) / 100);
    ...
    function changeBlazeAIWallet(address _blazeAIWallet) external onlyOwner {
        require(
            _blazeAIWallet != blazeAIWallet,
            "BlazeAI wallet is already that address"
        );
        require(
            _blazeAIWallet != address(0),
            "BlazeAI wallet cannot be the zero address"
        );
        blazeAIWallet = _blazeAIWallet;

        emit BlazeAIWalletChanged(blazeAIWallet);
    }
    ...
    function _transfer(
        ...
        if (canSwap && !swapping && to == uniswapV2Pair && swapEnabled) {
            ...
            swapAndSendBlazeAI(contractTokenBalance);
    ...
    function setBurnEnabled(bool _enabled) external onlyOwner {
        require(burnEnabled != _enabled, "burnEnabled already at this state.");
    ...
    function swapAndSendBlazeAI(uint256 tokenAmount) private {
        ...
        payable(blazeAIWallet).sendValue(address(this).balance);

        liquidityProvider = 0;

        emit SwapAndSendBlazeAI(tokenAmount, newBalance);
    }
