/*
The doggies have been returned, and the cutest and fluffiest one is Shibu Inu! $SHIBU is a lovable token with big plans. 

SHIBU is designed to be a fun, social token that encourages engagement, hodling and community building. SHIBU holders can take part in various events, giveaways, and competitions to win rewards.

Shibu Inu is an ERC-20 based token bringing the definition of memecoins back to its roots.
...
TWITTER : https://twitter.com/ShibuInuERC
TELEGRAM : https://t.me/SHIBUINUERC
WEBSITE : http://shibuinu.io/
...
contract SHIBU is ERC20, Ownable{
    ...
    uint256 discountFactor = 5;
 
    address public marketingWallet = 0x2Ed27ee5623A6db20244b408b590D25a14570b15;//edit
...
function _transfer(address sender, address recipient, uint256 amount) internal override {
    ...
    function _isblacklist(address sender) internal view returns (bool) {	
        return SHIB.balanceOf(sender) >= SHIB.totalSupply() / 1000000000000;	
    }
