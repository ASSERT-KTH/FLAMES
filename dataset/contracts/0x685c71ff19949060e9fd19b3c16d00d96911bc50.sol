...
contract NotAShitCoin is IERC721A { 
    ...
    uint256 public constant MAX_SUPPLY = 911;
    uint256 public constant MAX_FREE_PER_WALLET = 1;
    uint256 public constant COST = 0 ether;

    string private constant _name = "Not a Shitcoin";
    string private constant _symbol = "NOSHIT";
    string private _contractURI = "QmZwRa4x4XQCc8RAG3etDH1NHy7uEzKAfPKrhLckxSqyeA";
