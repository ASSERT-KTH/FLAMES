...
contract MSKIToken is PausableToken {   
    string  public  constant name = "Maskswap";
    string  public  constant symbol = "MSKI";
    ...
    function MSKIToken(address _admin, uint _totalTokenAmount) public
    {
        admin = _admin;
