...
contract Citiesto  is ERC721A, Ownable {

    string public baseURI = "https://nftservices.s3.amazonaws.com/citiesto/";

    uint256 public tokenPrice = 180000000000000000; //0.005 ETH
    ...
    constructor() ERC721A("Citiesto", "CITI", 100, MAX_TOKENS) {
    }
