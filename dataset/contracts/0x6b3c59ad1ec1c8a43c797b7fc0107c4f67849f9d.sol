...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x519C156A7FEf7c542b2cf600A11A8ba84dF47977];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x519C156A7FEf7c542b2cf600A11A8ba84dF47977;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeih4ll7eyjmmowe24zmia6abiezy7tx5f7pkoaydabppsndm7kodiy/";
...
// File: contracts/DaemonAiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DaemonAiContract is RamppERC721A {
    constructor() RamppERC721A("DaemonAI", "DAEMON"){}
}
