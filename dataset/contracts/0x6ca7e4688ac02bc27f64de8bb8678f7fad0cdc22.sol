...
contract HACON is Ownable, ERC20Token {

    using Math for uint;

    uint8 constant public decimals = 18;
    string constant public symbol = "HACON";
    string constant public name = "HACON";
    
    address constant company = 0x379e6c6f65AA6C9B04e3dE1e4deF8769396729f4;
