...
contract TRUST is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmP5m7zYGVjxq75MZJ2hA1MQuSD6rs87SckjZWV2iJtksh";
    ...
    constructor(
    ) ERC721A("dude trust me", "TRUST", 100, maxSupply) {
    }
