...
// File: contracts/LightMarketOracle.sol
    ...
    VolatilityOracleInterface
{
     ...
     */
    function recoveryPhaseCheck() external {
     ...
     */
    function getVolatility() external override returns (uint256) {
        uint256 to;
        uint256 from;
        uint256 _exTo;
        uint256 exFrom;
