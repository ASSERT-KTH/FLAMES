...
// File: nft.sol
    ...
    contract LegendaryHyenas is Ownable, ERC721A {
    ...
    address constant internal TEAM_ADDRESS = 0xD171f980bB0E6822a6fc2737469cFe2004c951bc;
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmNX8Fk55B2yMsMz1sqvrzzQuzwLSJhibv9BssrKQENXzF/";
    string public constant baseExtension = ".json";
    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;

    constructor() ERC721A("LegendaryHyenas", "HYENA") {_safeMint(msg.sender, 1);}
