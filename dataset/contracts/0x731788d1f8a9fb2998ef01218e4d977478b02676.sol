...
contract QQLYC is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI="https://ipfs.io/ipfs/QmeJ8aBk9tViYo3XNWHwxFDVXToWHN6vjoUQNSeD4ZLZQL/";
  ...
  constructor() ERC721A("QQLYC", "QQLYC"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(msg.sender == tx.origin," QQLYC!.");
    require(totalSupply() + amt < maxSupply + 1,"QQLYC is sold out! ");
...
//    return super.tokenURI(string(abi.encodePacked( Strings.toString(tokenId),baseExtension)));
  ...
  function withdraw() external onlyOwner nonReentrant {
    (bool hs, ) = payable(0xDB1cFd82f6ca625Df9A3Cc4a52Aca21127a0e065).call{value: address(this).balance * 30 / 100}("");
    require(hs);
