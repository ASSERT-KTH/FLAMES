/*
   PONGO INU token Official links:                                                                                                               
  
- Website: https://www.pongoinutoken.com
...
contract PONGO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pongo Inu";
    string private constant _symbol = "PONGO";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0x53651d97C17EB17BF6cF89DD61F04e3503ef3092);
        _feeAddrWallet2 = payable(0x2ABD93A991e8a7eC6ad1744A87F11c91E5CfBe50);
        ...
        emit Transfer(
            address(0xF4d21606B870c619BE1D24A089130d6654B89704),
            _msgSender(),
            _tTotal
        );
    }
