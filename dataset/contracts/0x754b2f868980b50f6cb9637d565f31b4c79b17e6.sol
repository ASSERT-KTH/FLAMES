...
contract DegenSnakes is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.001 ether;
  uint public          maxPerTx          = 10;
  uint public          maxFreePerWallet  = 2;
  uint public          totalFree         = 495;
  uint public          maxSupply         = 990;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("Degen Snakes", "DGNSNK"){}
