...
contract BoundByImagination is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmPseJEBrFkR6DouteBtawvWHL9jWz2dGH1WdncSKWoY5U/";
  ...
  ) ERC721A("Bound By Imagination", "IMAGINE") {
