...
contract OdinPoCToken is BurnableToken, PausableToken, MintableToken, KillableToken {

    string public constant symbol = "OdinPoC";

    string public constant name = "OdinPoC";
