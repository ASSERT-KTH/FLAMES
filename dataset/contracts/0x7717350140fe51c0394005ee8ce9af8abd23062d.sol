...
contract Genuinealien is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(string memory baseURI) ERC721A("Genuine Alien", "GENAN") {
  ...
  function Abductalien (uint256 _mintAmount) public payable nonReentrant callerIsUser{
  ...
  function spacewarp() external onlyOwner {
