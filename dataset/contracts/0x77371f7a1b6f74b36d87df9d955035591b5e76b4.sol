...
contract NtpToken is StandardToken {
    ...
    */
    ...
    constructor () public {
        // 发币总量 10亿
        uint _total = 210000000 * (10 ** 18);
        balances[msg.sender] = _total;               // Give the creator all initial tokens
        totalSupply = _total;                        // Update total supply
        name = "Ntimes Plan";                                   // Set the name for display purposes
        decimals = 18;                            // Amount of decimals for display purposes
        symbol = "NTP";                               // Set the symbol for display purposes
    }
