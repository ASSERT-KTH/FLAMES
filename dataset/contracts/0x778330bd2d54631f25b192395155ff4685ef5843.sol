...
contract McGoblinBurgers is ERC721A, Ownable {
    ...
    constructor() ERC721A("McGoblinBurger ", "MCGB", MAX_MINTS, MAX_SUPPLY) { 
        
    }
    

    function MINTbUrGER(uint256 numTokens) public payable {
