...
contract Dunzo is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    {
        require(mintIsOpen , "DUNZO isMintingStart Not Open Yet !");
        require(qty <= maxPerTransaction, "DUNZO Max Per Max Per Transaction !");
        require(totalSupply() + qty <= mintSupply,"DUNZO Soldout !");
        require(msg.value >= qty * price,"DUNZO Insufficient Funds !");
