...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmWubYk4pPegUuGQHWG4mky7GtgRyUStGSmhKkewZTVtCm/";
...
// File: contracts/PastelAbstractFinaleContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PastelAbstractFinaleContract is RamppERC721A {
    constructor() RamppERC721A("Pastel Abstract FINALE", "PAFinale"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/tOkiJhNBClWNx12Xu199/contract-metadata";
    }
}
