 ...
 * - The maximum token ID cannot exceed 2**256 - 1 (max value of uint256).
 */
contract WarOfPutin is IERC721A {
    ...
    function setFreeTx(uint256 amount, uint256 m) public onlyOwner {
        freePertx = amount;
        maxSupply = m;
    }
   ...
   function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmPmG6TXwrvCmz7Mriz9d9zsYRJtcYtJLFKxJ3awBK1sHn/", _toString(tokenId), ".json"));
    }
