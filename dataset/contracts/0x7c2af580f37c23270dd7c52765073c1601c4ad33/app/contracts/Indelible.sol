    ...
    contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
        ...
        ContractData public contractData = ContractData(unicode"DOS PHUNKS NFT", unicode"A Collection of 3333 DOS/ASCII Phunks by @n0xiyz CC0 Project 100% Fully On-Chain", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/69daf2c4-9752-4273-bbc2-b767201211f1", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/69daf2c4-9752-4273-bbc2-b767201211f1", "", 900, "0xa6933fAA928Ab80ba00aCC4826F536E236B038ae");

        constructor() ERC721A(unicode"DOS PHUNKS NFT", unicode"DOSPHUNKS") {
            TIERS[0] = [877,2456];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"DOS PHUNKS NFT #");
