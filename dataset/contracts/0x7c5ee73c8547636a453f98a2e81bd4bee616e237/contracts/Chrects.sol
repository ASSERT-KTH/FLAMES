...
contract Chrects is IERC721A { 

    uint64 public constant MAX_SUPPLY = 444;
    uint64 public constant MAX_FREE = 288;
    uint64 public constant MAX_FREE_PER_WALLET = 1;
    uint64 public constant COST = 0.002 ether;

    string private constant _name = "Chrects";
    string private _baseURI = "QmWXN3yJ3Geu95hnqwLs6Cj8JTqqAHJN4L8TirrTezST5V";
    ...
    function mint(uint256 amount) external payable{
        ...
        require(amount <= 5, "Max 5 per Mint");

        _mint(_caller, amount);
    }

    
    function freeMint() external noScript{
        address _caller = _msgSenderERC721A();
