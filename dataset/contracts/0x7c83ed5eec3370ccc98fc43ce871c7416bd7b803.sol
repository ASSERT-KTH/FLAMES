...
contract HegicRewards is Ownable {
    ...
    uint public LAST_OPTION_ID = uint(-1);
    ...
    function getReward(uint optionId) external {
        ...
        require(optionId <= LAST_OPTION_ID, "Wrong Option ID");
    ...
    function setLastID(uint lID) external onlyOwner {
        LAST_OPTION_ID = lID;
    }
