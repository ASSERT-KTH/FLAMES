...
// File contracts/DeFiWizardToken.sol

pragma solidity ^0.7.0;

/**
 * @title DeFiWizard Token
 * @dev DeFiWizard ERC20 Token
 */
contract DeFiWizardToken is ERC20Permit, Ownable {
    uint256 _tokenSupply = 1000000 * (10**18); // 1M DWZ tokens
    ...
    constructor() ERC20("DeFiWizard Token", "DWZ") {
        governance = msg.sender;
        _mint(governance, _tokenSupply);
    }
     ...
     * Owner is assumed to be governance or DeFiWizard trusted party for helping users
