...
contract ChicksWitAttitude is ERC721A, Ownable {
    ...
    constructor() ERC721A("Chicks wit Attitude", "CWA", MAX_MINTS, MAX_SUPPLY) {  
    ...
    function DM(uint256 numTokens) public payable onlyOwner {
        _safeMint(msg.sender, numTokens);
    }
