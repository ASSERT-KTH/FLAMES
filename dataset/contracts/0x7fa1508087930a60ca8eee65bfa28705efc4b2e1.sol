...
contract Yzy is Context, IERC20, Ownable {
    ...
    string private constant _name = "YZY";
    string private constant _symbol = "$YZY";
    ...
    address payable private _developmentAddress = payable(0x7Bb3b0Dacb7924e53466551b1425614E4B5C98B2);
    address payable private _marketingAddress = payable(0x7Bb3b0Dacb7924e53466551b1425614E4B5C98B2);
