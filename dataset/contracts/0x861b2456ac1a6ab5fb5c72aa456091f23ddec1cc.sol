...
contract VAULTZ is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7777 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "VAULTZ";
    string private _symbol = "VAULTZ";
