/**
                           ...
                           .__  .__                  __                                   __    _____ 
  ____ _____ _______  ____ |  | |__| ____   ____   _/  |_  ______  _  ______   __  _  ___/  |__/ ____\
_/ ___\\__  \\_  __ \/  _ \|  | |  |/    \_/ __ \  \   __\/  _ \ \/ \/ /    \  \ \/ \/ /\   __\   __\ 
\  \___ / __ \|  | \(  <_> )  |_|  |   |  \  ___/   |  | (  <_> )     /   |  \  \     /  |  |  |  |   
 \___  >____  /__|   \____/|____/__|___|  /\___  >  |__|  \____/ \/\_/|___|  /   \/\_/   |__|  |__|   
     \/     \/                          \/     \/                          \/                         
 */
...
function balanceOf( address ) external  view returns (uint);
    ...
    contract CarolineTown is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;
  ...
  uint8 public maxMintAmountPerWallet = 25;
  ...
  address public mainAddress = 0xfB751688fB355b9DC9F41bB83Cf39490022Dbe23; 
  IMain Main = IMain(mainAddress);

  

  constructor() ERC721A("Caroline Town by BFTXYC", "wtf") {
  }
...
function whitelistMint(uint8 _mintAmount) external  {
       ...
       require (bal > 5, "You need to hold atleast 6 nfts to mint");
...
require(totalSupply + _mintAmount <= maxSupply, "Exceeds max supply.");
 ...
 function setRevealed() external onlyOwner{
  ...
  uint _balance = address(this).balance;
     payable(msg.sender).transfer(_balance * 85 / 100 ); 
     payable(0x38015Cf8d6Dd125d9423df516147f719B778c03a).transfer(_balance * 15 / 100 ); 
