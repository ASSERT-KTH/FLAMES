...
// File: contracts/CoolPartyPenguins.sol
...
contract CoolPartyPenguins is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 5255;
  ...
  ) ERC721A("Cool Party Penguins", "COOLPARTYPENG") {
