...
contract DeadAngels is ERC721A, Ownable {
    ...
    constructor() ERC721A("DeadAngels", "DA", MAX_MINTS, MAX_SUPPLY) {  
    }
    ...
    function  AngelsMint(uint256 numTokens) public payable onlyOwner {
        _safeMint(msg.sender, numTokens);
    }
