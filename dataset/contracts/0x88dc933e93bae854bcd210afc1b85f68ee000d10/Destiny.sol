...
Destiny A.I. is an offline business / company first and a Web3 project second.

We specialize in customizing OpenAI based A.I. models which we run on our own hardware.
Enter our Telegram channel and try out Destiny A.I. which we have upgraded with our custom "Soul" dataset.

Join the future of Business!

- Website: www.destiny-ai.com
- Telegram: t.me/TheDestinyAI
- Twitter: @RealDestinyAI

Token launch on February 23rd @ 8pm CET

This is the only official contract of the $DEST token! 
...
contract Destiny is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletAmount = _tTotal/200; 
    ...
    string private constant _name = "Destiny A.I.";
    ...
    uint256 public numTokensSellToAddToLiquidity = _tTotal/2000;
