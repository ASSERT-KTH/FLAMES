...
https://twitter.com/uberinueth

uberinu.xyz

https://t.me/Uberinuportal
...
contract UberInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Uber Inu";
    string private _symbol = "uber";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0xC39Ea31d980962b1c7C69fF38E39bA8cCAc5136b);
    address payable public DeveloperWallet = payable(0x849bdc95024f37EdB46C995be5b6172e5f7e74E3);
