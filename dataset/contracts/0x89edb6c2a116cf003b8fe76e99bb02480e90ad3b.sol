...
contract AssasinsBloodline is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmeBCDq2dP6J72zBYxN2JxLKWm8dc1fTLzejF2xB5inbo4/";
  uint256  public  maxSupply = 1222;
  uint256 public  MAX_MINTS_PER_TX = 15;
  uint256 public  PUBLIC_SALE_PRICE = 0.001 ether;
  uint256 public  NUM_FREE_MINTS = 622;
  ...
  ) ERC721A("Assasins Bloodline", "ASNBLD") {
