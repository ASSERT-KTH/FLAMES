...
contract FrogRunners is ERC721A, Ownable, Pausable, ReentrancyGuard {
  using Strings for uint256;
  ...
  constructor() ERC721A("FrogRunners", "RIBBIT") {
    setBaseURI("");
  }
  ...
  function mintFree(uint256 _mintAmount) public payable nonReentrant{
    ...
    require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max Frogs per address exceeded");
		require(_mintAmount > 0, "Cannot mint 0 Frogs" );
		require(s + _mintAmount <= maxFree, "Cannot exceed Frogs supply" );
  ...
  function mint(uint256 _mintAmount) public payable nonReentrant {
    uint256 s = totalSupply();
    require(_mintAmount > 0, "Cant mint 0 Frogs");
    require(_mintAmount <= maxperAddressPublicMint, "Cant mint more Frogs" );
    require(s + _mintAmount <= maxSupply, "Cant exceed Frogs supply");
    ...
    onlyOwner
  {
    ...
    require(s + totalQuantity <= maxSupply, "Too many Frogs");
