// File: contracts/EmojiBattle.sol
...
contract EmojiBattle is Ownable, ERC721A {
  string public baseURI = "https://bafybeibm5e3nbygem4xfp2agyiejsngqrczb56jctiawvx6joxll7sozwq.ipfs.nftstorage.link/";
  ...
  constructor(uint256 _mintCntToOwner) ERC721A('Emoji Battle', 'EJB') {
  ...
  function mint(uint256 quantity) external payable {
    unchecked {
      ...
      if (isFreeMintOpen == false || currentSupply >= 7333) {
