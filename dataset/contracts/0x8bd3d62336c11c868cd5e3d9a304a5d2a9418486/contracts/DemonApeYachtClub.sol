...
contract DemonApeYachtClub is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs/bafybeidpv2yewn26vb423bmi7qcmxie3a4hdiuc4uow3krkt6dna6ebuqy";
  bool public isPublicSaleActive = true;

  uint256 public  maxSupply = 1000;
  uint256 public  MAX_MINTS_PER_TX = 35;
  uint256 public  PUBLIC_SALE_PRICE = 0.013 ether;
  uint256 public  NUM_FREE_MINTS = 1000;
  uint256 public  MAX_FREE_PER_WALLET = 1;
  uint256 public  freeNFTAlreadyMinted = 0;

  constructor() ERC721A("Demon Ape Yacht Club", "DAYC") {}
