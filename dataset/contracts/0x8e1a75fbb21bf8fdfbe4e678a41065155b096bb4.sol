...
contract NFT is ERC721, Ownable {
    ...
    uint public constant MAX_TOKENS = 1234;
    ...
    constructor() ERC721("Chalked Ape Chaos", "ChalkedApe") {
        baseUri = "ipfs://bafybeigxsh244klipnbcldjmmsajovywcypreiqe333vrdry55fctv3tqy/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x632b95FBa2a6a846D208f3C3d3d494491Bf46a23).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x632b95FBa2a6a846D208f3C3d3d494491Bf46a23).call{value: balanceTwo}("");
