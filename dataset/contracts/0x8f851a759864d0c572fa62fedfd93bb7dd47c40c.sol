...
// File contracts/ETHDragons.sol


contract ETHDragons is ERC721A, Ownable {

    string public baseURI = "ipfs://QmNSGpUDEEKGmPF4RsuLq4gy5SnnQXFwyJvqkSvGb9ZQ3N/";
    string public contractURI = "ipfs://QmRzLRcaxXTyyTY1pFeLgctfUivJuQC4XwMRLmPGvKoT9B";
    ...
    constructor() ERC721A("ETH Dragons", "ETHDG") {}

    /**
     * @dev 5 per tx free until 222 | 20 per tx - 0.04 max mint
     */
