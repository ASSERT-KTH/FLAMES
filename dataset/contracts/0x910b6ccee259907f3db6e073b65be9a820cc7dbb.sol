...
contract TYRANTPREDATOR is ERC20, Ownable {
    ...
    constructor() ERC20("Tyrant Predator", "ION") {
        ...
        marketingWallet = address(0x4648f27090f26daF26fCb5ce18e37051D7e5c23f); // set as marketing wallet
        devWallet = address(0x4648f27090f26daF26fCb5ce18e37051D7e5c23f); // set as dev wallet
