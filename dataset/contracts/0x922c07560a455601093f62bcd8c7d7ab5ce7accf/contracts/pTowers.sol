...
contract pTowers is IERC721A { 
    ...
    string private constant _name = "pTowers";
    string private constant _symbol = "pTOWERS";
    string private _baseURI = "QmVmHeeur1tzTmujKuu7LwDABHERZpF9ChwvQtNdKdBmte";
