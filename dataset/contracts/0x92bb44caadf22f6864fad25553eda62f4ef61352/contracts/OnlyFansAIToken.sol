/*
    Website:    https://onlyfansai.vip/
    Twitter:    https://twitter.com/OnlyFansAI_eth
    Telegram:   https://t.me/OFAIcoin
    Gitbook:    https://onlyfansai.gitbook.io/onlyfans-ai/
    Linktree:   https://linktr.ee/OnlyFansAI_eth
*/
...
contract OnlyFansAIToken is ERC20, Ownable {
    ...
    constructor()
        ERC20(
            unicode"Only Fans AI",
            unicode"OFAI"
        )
    {
        uint256 totalSupply = 69_000_000_000 ether;
        address treasuryWallet = 0xC3C3d0b93d477fB9414E39b4EDE6433C5CDe86A0;
        ...
        marketingWallet = 0xE46566034ab942A55e25Fe6CbA247a08C5E0B4b1;
        developmentWallet = 0xE46566034ab942A55e25Fe6CbA247a08C5E0B4b1;
        liquidityWallet = 0xE46566034ab942A55e25Fe6CbA247a08C5E0B4b1;
        ...
        _mint(treasuryWallet, (totalSupply * 15) / 100);
        _mint(address(this), (totalSupply * 25) / 100);
        _mint(owner(), (totalSupply * 60) / 100);
    }
