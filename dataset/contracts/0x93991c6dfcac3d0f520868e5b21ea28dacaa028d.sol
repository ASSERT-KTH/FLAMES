...
contract Sins is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmRTRjdDphdJ7FwFmXm9SJUpiMW2xgxFe7HNm1hsRVfLVo";
    ...
    constructor(
    ) ERC721A("Spiritual Sins", "SINS", 100, maxSupply) {
    }
