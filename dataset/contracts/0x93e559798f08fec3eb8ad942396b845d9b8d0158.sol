...
contract UnusualPotatoz is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmfPY3ungZ8CviwxH3rFicRt5Pf6hbrM77SJtTGMAjg4HR/";
    ...
    constructor(string memory initBaseURI) ERC721A("Unusual Potatoz", "UP") {
        baseURI = initBaseURI;
