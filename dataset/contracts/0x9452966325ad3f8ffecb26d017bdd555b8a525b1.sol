...
contract CIA is ERC20, Ownable {
    ...
    constructor() ERC20("Celcius Internet Archive", "CIA") {
        ...
        marketingWallet = address(0xAE063c66eDF56eE879dd9dC88E936620f8870B95); // set as marketing wallet
        devWallet = address(0xAE063c66eDF56eE879dd9dC88E936620f8870B95); // set as dev wallet
