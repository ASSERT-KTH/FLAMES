...
contract DeFiMingLP is ERC20, ERC20Detailed, ERC20Pausable {
    
    // metadata
    string public constant tokenName = "DeFiMingLP";
    string public constant tokenSymbol = "DFMLP ";
    uint8 public constant decimalUnits = 8;
    uint256 public constant initialSupply = 11000000;
