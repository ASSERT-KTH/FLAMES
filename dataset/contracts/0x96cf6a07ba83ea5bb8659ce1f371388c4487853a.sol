...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract ProofOfBurgers is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;


  string private uriPrefix ;
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://Qmcpwpm2M2Npf9vq3B5jTNf2ctfWhbmK9H1E1kZSBHRaQv/Burgerzzzz.json";
  ...
  constructor() ERC721A("Proof Of Burgers", "POBS") {
  }
