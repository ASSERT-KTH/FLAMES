...
contract YinsStory is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmTe7waCRmEhqDMNP2tG9UxdFrhgd61gJpuP947Fu7cQ";
    ...
    constructor(
    ) ERC721A("Yins Story - by Daiyu Sing", "Yin", 100, maxSupply) {
    }
