...
contract MoonSaudis is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmP35rG6UsjmimEBZnkGPdBT7XnMPA6aaBReFvy7U9KoiK";
    ...
    constructor(
    ) ERC721A("MoonSaudis", "MS", 100, maxSupply) {
    }
