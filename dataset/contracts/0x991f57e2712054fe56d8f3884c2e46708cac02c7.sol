...
contract HDTTokenWrapper {
    ...
    //BSC
    IERC20 public stakeToken = IERC20(0xe541504417670FB76b612B41B4392d967a1956c7); 
 ...
 * HDT-BSC Pool
 */
contract HDTBSCPool is HDTTokenWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        require(amount > 0, "HDT-BSC-POOL: Cannot stake 0");
        super.stake(amount);
        emit Staked(msg.sender, amount);
    }

    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        require(amount > 0, "HDT-BSC-POOL: Cannot withdraw 0");
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"HDT-BSC-POOL: Not start");
        _;
    }

    modifier checkOpen() {
        require(open, "HDT-BSC-POOL: Pool is closed");
        _;
    }
