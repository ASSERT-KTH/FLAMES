...
// ERC721A/S Created by NFT Elite Consulting x MisterSausage for Internet of Rage
...
contract InternetOfRage is ERC721A, Ownable  {
  using SafeMath for uint256;
	using Strings for uint256;
    bytes32 public merkleRoot;
    bytes32 public vipMerkleRoot;
    uint256 constant public MAX_SUPPLY= 4500;
	  uint256 constant public MAX_WL_SUPPLY = 1000;
    uint256 constant public MAX_VIPWL_SUPPLY = 1000;
    uint256 public WL_PRICE = 0.1 ether;
    uint256 public VIPWL_PRICE = 0 ether;
    uint256 public PRICE = 0.2 ether;
    uint256 public giveawayLimit = 4500;
    string public baseTokenURI;
    bool public whitelistSaleIsActive;
    bool public saleIsActive;
    address private wallet1 = 0xa505BDb98eb6C78a672c9E5291df51E125d50683; // Company Wallet
    address private wallet2 = 0xD81581c0A10ffA6A0cAd2EF8dd507c2c9E759F3f; // Company Wallet #2
    address private wallet3 = 0x6E191a18c8C04C5cd30D5F5d7EbDA2681676FCb0; // Company Wallet #3
    address private wallet4 = 0x549418604D15df787eb24ca47f1F02fCF1600A52; // Mkt
    ...
    constructor() ERC721A("Internet of Rage", "IoR") { }
    ...
    function withdraw() public onlyOwner {
        ...
        (bool wallet1Success, ) = wallet1.call{value: _amount.mul(45).div(100)}("");
        (bool wallet2Success, ) = wallet2.call{value: _amount.mul(44).div(100)}("");
        (bool wallet3Success, ) = wallet3.call{value: _amount.mul(8).div(100)}("");
