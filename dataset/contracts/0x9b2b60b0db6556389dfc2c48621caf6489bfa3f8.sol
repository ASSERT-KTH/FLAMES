...
contract Runnnnnnning  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://bafybeihjkml56l3rugjztctegnvxsod4qww7m5vyarpyxd2phbepw523xe/";
    ...
    constructor()
    ERC721A ("Runnnnnnning", "Runnnnnnning") {
    }
    ...
    function RunningDrop(address to, uint256 amount) external onlyOwner {
        require(totalSupply() + amount <= maxSupply, "Request exceeds collection size");
        _safeMint(to, amount);
    }

    function RunningMint(uint256 quantity) external payable onlyOwner {
