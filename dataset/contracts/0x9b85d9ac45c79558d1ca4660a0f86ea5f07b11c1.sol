...
contract DejitaruBuka is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address private  deadAddress = address(0x0178E54776c17E09ca5cB7DfDD3a5519eC2F2D5c);
    ...
    constructor() ERC20("Dejitaru Buka", "BUKA") {
    ...
    function setBUKAModifier(address account, bool onOrOff) external onlyOwner {
