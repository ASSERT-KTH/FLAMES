...
contract PitteyPoney is Ownable, ERC721A {
    ...
    constructor(string memory _initBaseURI) ERC721A("PitteyPoney", "Poney") {
    ...
    if (revealed == false) {
            return "https://gateway.pinata.cloud/ipfs/QmPrjTVBgwFHF2KSwtckQ5n7i27MvweQpf5x4N2GcfJh2E/_metadata.json";
    }
