...
// File: contracts/AreYouSeeingThis.sol
...
contract AreYouSeeingThis is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  ...
  uint256 public  NUM_FREE_MINTS = 1337;
  ...
  ) ERC721A("AreYouSeeingThis", "HELPME") {
