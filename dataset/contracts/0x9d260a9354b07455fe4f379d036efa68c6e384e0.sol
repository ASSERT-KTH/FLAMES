...
contract AIWomen is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmbAFxnxERUvCNz78zjALsaeXyAD6SLhTEvtiSvjfM2rvh";
    ...
    constructor(
    ) ERC721A("AIwomen", "AI", 100, maxSupply) {
    }
