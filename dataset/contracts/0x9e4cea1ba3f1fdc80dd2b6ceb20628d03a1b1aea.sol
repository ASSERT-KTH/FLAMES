...
// File: contracts/AnatomyPudgyPenguins.sol
...
contract AnatomyPudgyPenguins is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 3215;
  ...
  ) ERC721A("Anatomy Pudgy Penguins", "APP") {
