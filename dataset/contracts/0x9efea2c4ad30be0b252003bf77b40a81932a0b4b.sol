...
contract Wives is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmeLQsiV3EYDehKmaFCEbvsFpK9gtJEcgnRpCMvz6nZ2p9/hidden";
    ...
    uint256 public constant PUBLIC_SALE_PRICE = 0.0029 ether;
    ...
    constructor(
    ) ERC721A("The Saudi Apes", "SAPES", 100, maxSupply) {
    }
        ...
        returns (string memory)
    {
        ...
        return
            string(abi.encodePacked(baseURI, ".json"));
    }
