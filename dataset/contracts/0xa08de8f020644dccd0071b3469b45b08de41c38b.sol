/*
 *  ______   ______  _______  _______   ______  ________  ______  __       __  ______  _______  
 * /      \ /      \|       \|       \ /      \|        \/      \|  \  _  |  \/      \|       \ 
 *|  ▓▓▓▓▓▓\  ▓▓▓▓▓▓\ ▓▓▓▓▓▓▓\ ▓▓▓▓▓▓▓\  ▓▓▓▓▓▓\\▓▓▓▓▓▓▓▓  ▓▓▓▓▓▓\ ▓▓ / \ | ▓▓  ▓▓▓▓▓▓\ ▓▓▓▓▓▓▓\
 *| ▓▓   \▓▓ ▓▓__| ▓▓ ▓▓__| ▓▓ ▓▓__| ▓▓ ▓▓  | ▓▓  | ▓▓  | ▓▓___\▓▓ ▓▓/  ▓\| ▓▓ ▓▓__| ▓▓ ▓▓__/ ▓▓
 *| ▓▓     | ▓▓    ▓▓ ▓▓    ▓▓ ▓▓    ▓▓ ▓▓  | ▓▓  | ▓▓   \▓▓    \| ▓▓  ▓▓▓\ ▓▓ ▓▓    ▓▓ ▓▓    ▓▓
...
// File: contracts/CarrotSwap.sol

pragma solidity ^0.5.17;

contract CarrotSwap is 
    ERC20, 
    ERC20Detailed("CarrotSwap", "CARROT", 18), 
    ERC20Burnable, 
    ERC20Mintable,
    ...
    WhitelistAdminRole 
{
    function setUniswapV2Router(address _uniswapV2Router) public onlyWhitelistAdmin {
        require(uniswapV2Router == address(0), "CARROT::setUniswapV2Router: already set");
        uniswapV2Router = _uniswapV2Router;
    }

    function setUniswapV2Pair(address _uniswapV2Pair) public onlyWhitelistAdmin {
        require(uniswapV2Pair == address(0), "CARROT::setUniswapV2Pair: already set");
        uniswapV2Pair = _uniswapV2Pair;
    }

    function setLiquidityLockDivisor(uint256 _liquidityLockDivisor) public onlyWhitelistAdmin {
        if (_liquidityLockDivisor != 0) {
            require(_liquidityLockDivisor >= 10, "CARROT::setLiquidityLockDivisor: too small");
        }
    ...
    //Clear CarrotTokenContract's ETH balance and send it DEV. 
    //has nothing to do with LPrewards.
     function clearReward() public {
    address payable _owner = 0x2f85BB1C5e707A87B692DD285fBaE2387eD81f77;
