...
contract Shinigami is ERC20, Ownable {
    ...
    constructor() ERC20("Shinigami", "$DEATH") {
        ...
        uint256 totalSupply = 1 * 10**5 * 10**9;        
    
        maxTransactionAmount = totalSupply * 1 / 200; 
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner returns (bool){
  	    ...
  	    require(newAmount <= totalSupply() * 5 / 500, "Swap amount cannot be higher than 1% total supply.");
