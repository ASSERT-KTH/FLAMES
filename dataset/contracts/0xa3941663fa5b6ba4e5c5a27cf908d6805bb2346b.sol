...
contract BabyLazyBunnies is ERC721A, Ownable {
    ...
    constructor(address _NFTAddress, uint256 _supply) ERC721A("Baby Lazy Bunnies", "BBLZB") {
    ...
    function claimAirdrop() external {
        ...
        require(nftToMint > 0, "No NFTs to claim");
        mint(nftToMint);
    }
