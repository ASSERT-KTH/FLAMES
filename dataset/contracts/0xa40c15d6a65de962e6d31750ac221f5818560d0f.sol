...
With Max Wallet of 1 Token, everyone in Average Joe is a small bag holder, a true Crypto Community 🤝


With a Doxxed from the UK who ran a previous project to $24M 🤯


Be part of something special, grab a token and join us. We have beers 🍻


🌐 https://www.averagejoe.website/
🐦 https://twitter.com/AverageJoeERC20
💬 https://t.me/averagejoeerc20
...
contract JOE is ERC20, Ownable {
    uint256 public _maxTxAmount = 1 * 10 ** decimals();
    uint256 public _maxWalletSize = 1 * 10 ** decimals();
    uint256 public _swapTokensAtAmount = 1 * 10 ** decimals();
    uint256 public _amountToSwap = 1 * 10 ** decimals();
    ...
    constructor() ERC20("AVERAGE JOE", "JOE") {
