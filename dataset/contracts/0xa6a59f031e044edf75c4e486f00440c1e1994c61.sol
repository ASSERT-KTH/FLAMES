/*
    ...
    Start with 10% tax then reduced to 0 tax

    https://twitter.com/SegwitERC
...
contract BitcoinProtocol is IERC20, Ownable {
    ...
    string constant _name = "Bitcoin Protocol";
    string constant _symbol = "SEGWIT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals); // 100,000,000,000
