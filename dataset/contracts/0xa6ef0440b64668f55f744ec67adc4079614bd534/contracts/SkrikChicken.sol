...
contract SkrikChicken is ERC721A, Ownable {


    string  public uriPrefix = "ipfs://QmNffzhUMqUkodrvvzoEAmT9cg5rrbJB3WA4kLwUJX5nq6/";
    ...
    function publicMint(uint32 amount) public payable callerIsUser{
        ...
        require(amount <= maxPerTx, "max 4 perTx");
