...
contract Nosamu is IERC721A { 
    ...
    uint256 public MAX_FREE = 460;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.001 ether;

    string private constant _name = "Nosamu";
    string private constant _symbol = "NOSAMU";
    string private _baseURI = "QmRWcdfreFeYBGGRd1nbFbt9mCKq7aS1uzXZcHvJUexsH5";
