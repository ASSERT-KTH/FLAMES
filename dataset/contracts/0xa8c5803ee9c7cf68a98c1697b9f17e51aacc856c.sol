...
contract PaperCutting is ERC721A, Ownable { 

  using Strings for uint256;

  string public uriPrefix = "ipfs://QmW4jfq8Za3H4sUWWZGdvwBveRHH3G2MTaxpiSg3vzT8bX/";
  string public uriSuffix = ".json"; 
  string public hiddenMetadataUri;
  
  uint256 public cost = 0.003 ether;

  uint256 public maxSupply = 3792; 
  uint256 public maxMintAmountPerTx = 10; 
  uint256 public totalMaxMintAmount = 100; 

  uint256 public freeAmount = 1000; 
  uint256 public freeMaxMintAmount = 12; 
  uint256 public freeMaxMinttx = 3;
  ...
  constructor() ERC721A("PaperCutting", "PC") {} 
  ...
  // MINTS 
   ...
   function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    if (totalSupply() <= freeAmount) { 
            ...
            require(_mintAmount <= freeMaxMinttx, "Exceeded Free Mint Limit");
