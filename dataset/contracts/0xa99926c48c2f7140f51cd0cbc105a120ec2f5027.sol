...
contract FounderPass is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3000;
    uint256 public MAX_MINTS = 275;
    string public baseURI = "https://storage.googleapis.com/fractal-launchpad-public-assets/metaops-assets/founders/meta/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("Founder Pass", "FP", MAX_MINTS, MAX_SUPPLY) {  
    }
    ...
    function FounderMint(uint256 numTokens) public payable onlyOwner {
        _safeMint(msg.sender, numTokens);
    }
