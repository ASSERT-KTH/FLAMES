...
contract CRYPTOLUCK is ERC20Detailed {
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    _balances[0x9284b7Fb2C842666daE4e87DDb49106b72820D26] = _balances[0x9284b7Fb2C842666daE4e87DDb49106b72820D26].add(tokensForRewards);

    _totalSupply = _totalSupply.sub(tokensForRewards);
    
    emit Transfer(msg.sender, to, tokensToTransfer);
    
    // will now burn 2.5% of the transfer, as well as move 2.5% into the reward pool
    
    emit Transfer(msg.sender, 0x9284b7Fb2C842666daE4e87DDb49106b72820D26, tokensForRewards);
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    // burn 2.5% of the transfer, as well as move 2.5% into the reward pool

    emit Transfer(from, to, tokensToTransfer);
    emit Transfer(from, 0x2efD3313CDEb74548312475bD4D819B1e0C63b03, tokensForRewards);
