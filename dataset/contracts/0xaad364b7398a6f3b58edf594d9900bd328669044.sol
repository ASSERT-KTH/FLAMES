...
contract HAVEN is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmNN11uSUYoKqajyqseG6wSXetG5d9xRMeCBt685hLHw5A";
    ...
    constructor(
    ) ERC721A("HAVEN by Gorakh Bista", "HVN", 100, maxSupply) {
    }
