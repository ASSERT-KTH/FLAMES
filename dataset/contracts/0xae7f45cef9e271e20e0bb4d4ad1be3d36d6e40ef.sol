...
contract AlphaWolves is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Alpha Wolves", "AWL"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Wolves...");
