...
contract Boukyaku is ERC20, Ownable {
    ...
    constructor() ERC20("Boukyaku", "YAKU") {
		...
		charityWallet = address(0xeaE24E63C086d0eC7aDf4CC915bb8073c510C3EE); // set as charity wallet
        marketingWallet = address(0xeaE24E63C086d0eC7aDf4CC915bb8073c510C3EE); // set as marketing wallet
        devWallet = address(0x25a9BC5F7C135FF5BaAa430de7a80b86f08834b8); // set as dev wallet
