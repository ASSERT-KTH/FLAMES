...
contract DOUG is ERC20, Ownable {
    ...
    constructor() ERC20("Doug the Pug", "DOUG") {
        ...
        uint256 _buyDevFee = 0; //donation wallet
 
        uint256 _sellMarketingFee = 5;
        uint256 _sellLiquidityFee = 0;
        uint256 _sellDevFee = 0; //donation wallet
        ...
        marketingWallet = address(0x22A19A62D127A33802D14d201980513672afD38d); // set as marketing wallet
        devWallet = address(owner()); // set as dev wallet or donation wallet
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x5942D998784EfE97580aa1D1dCA54A232675a24A,
            block.timestamp
        );
    }
