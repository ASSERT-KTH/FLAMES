...
//   `., )   (  ( _-`   \,'
//      "`'-,,`.jb
// Go catch some waves on Fishyx.sol, there's a surprise there
...
contract ERC721Tradeable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
  ...
  //Mint price 0.003 ETH | 10 with discount 0.024 | 20 with discount 0.048
  uint256 internal constant PRICE = 3000000;
  string public fishermanLocation = "";
