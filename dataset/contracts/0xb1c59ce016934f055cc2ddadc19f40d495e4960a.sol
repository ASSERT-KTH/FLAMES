...
// File: contracts/Peace_Family.sol



pragma solidity >=0.7.0 <0.9.0;

contract Peace_Family is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Peace Family", "Mr Peace") {
    setHiddenMetadataUri("ipfs://QmWBQxNPDhq4xHDj38rosNBWPafpLeogCeaZf4kjdMbH9t/hidden.json");
  }
