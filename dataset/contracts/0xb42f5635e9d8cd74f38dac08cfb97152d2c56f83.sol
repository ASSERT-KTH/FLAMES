...
contract SupDudes is ERC721A, Ownable, ReentrancyGuard {
    ...
    enum State {dude, suhdude}

    State private saleState_;
    
    //declaring initial values for variables
    constructor() ERC721A('SupDudes', 'SupDudes') {
        maxTotalTokens = 10022;

        _currentBaseURI = "ipfs://QmQFKdaFzoGxpj62MiUzHPhRrrGp9kD5oGV89SJnkUcrNA/";
    }
    ...
    function setSaleState(uint newSaleState) public onlyOwner {
        ...
        if (newSaleState == 0) {
            saleState_ = State.dude;
        }
        else {
            saleState_ = State.suhdude;
        }
    }
    ...
    function mint() public nonReentrant {
        ...
        require(saleState_ == State.suhdude, "Public Sale in not open yet!");
