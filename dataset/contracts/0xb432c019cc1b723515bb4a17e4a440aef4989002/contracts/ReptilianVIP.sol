...
contract ReptilianRepublicVIP is ERC721A, Ownable, ReentrancyGuard {
    ...
    address public constant w1 = 0xe8c72e38af775797C979c6F441D210d9F6900C6D;
        ...
        nonReentrant
    {
        ...
        require(!whitelistClaimed[msg.sender], "Reptilian is already claimed by this wallet");
    ...
    function reserve(uint256 tokens) external onlyOwner {
        require(totalSupply() + tokens <= maxSupply, "Minting would exceed max supply");
        require(tokens > 0, "Must mint at least one Reptilian");
        require(_walletMints[_msgSender()] + tokens <= 300, "Can only reserve 300 Reptilian");
