...
contract BeastLike is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 30000;
    uint256 public MAX_MINTS = 500;
    string public baseURI = "ipfs://QmcpBtGucqpBuF123JoUJ3fMrW9BcFRPwJRFCTVbTQLbbq/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("BeastLike", "BEST", MAX_MINTS, MAX_SUPPLY) {  
    }
