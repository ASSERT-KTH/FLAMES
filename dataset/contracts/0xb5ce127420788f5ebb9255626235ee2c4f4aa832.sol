...
contract JurassicEggs is ERC721A, Ownable {
    using Strings for uint256;
...
constructor() ERC721A("Jurassic Eggs", "EGG") {
        setHiddenMetadataUri("https://api.jurassiceggs.world/");
        setBaseURI("https://api.jurassiceggs.world/");
    }
