...
contract rorschacht3stalgo is ERC721A, OperatorFilterer, Ownable {
    // Variables
    ...
    uint256 public PAID_Mint_PRICE = 0.004 ether;
    ...
    constructor(string memory baseURI_) ERC721A("./Rorschach/Test/Insane", "axo") {
