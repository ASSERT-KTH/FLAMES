...
contract testerc721a is ERC721A, Ownable {
    ...
    uint256 public firstMintRate = 0.001 ether;
    uint256 public secondMintRate = 0.011 ether;
    

    bool public paused = true; 
    bool public revealed = true;

    string public baseURI = "ipfs://QmU1kw9R9bJyZbvPd3JE6FijST7h8iphsJb4TAxADgJhQT/";
    string public notRevealedBaseUri = "";
    string public baseExtension = ".json";

    address[] public whitelistedAddresses;

    constructor() ERC721A("CRYPTOFOXUS", "CFUS") {}
