...
// File: contracts/token/ERC20/AntiWhaleERC20.sol
...
/**
 * @title AntiWhaleERC20
 * @dev Implementation of the AntiWhaleERC20
 */
contract AntiWhaleERC20 is ERC20Detailed, ERC20AntiWhale, Ownable, ServicePayer {
    constructor(
        string memory name_,
        string memory symbol_,
        uint8 decimals_,
        ...
        ServicePayer(feeReceiver_, "AntiWhaleERC20", signature_, _msgSender())
    {
        require(initialBalance_ > 0, "AntiWhaleERC20: supply cannot be zero");
