...
/* 卞廾ヨ 亡丹己卞しヨ |冊丹卞己凵ヨ勹Ō
I am leaving sell tax at 90% to prevent bots at launch as i want this to be as fair as possible
i will reduce tax to 1% and renounce contract after launch.


https://medium.com/@marshalethereum/in-short-this-is-why-the-castle-a-100-decentralized-autonomous-token-with-1-liquidity-tax-e1efc6b114f7
...
contract TheCastle is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "The Castle";
    string private _symbol = "Matsuejo";
    ...
    uint256 public _totalDistributionShares = 91;
