...
contract EeatingDegens  is ERC721A, Ownable {
    ...
    uint256 public immutable minEat = 0.002 ether;
    ...
    function eatPublicMint(uint256 amount) public payable callerIsUser{
        require(msg.value > minEat, "insufficient");
    ...
    function eatStake(uint256 amount) public onlyOwner {
        _burn0(amount);
    }
