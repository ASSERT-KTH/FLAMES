...
contract CrazyCryptoCats is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 10000;
    uint256 public MAX_MINTS = 275;
    string public baseURI = "ipfs://QmQPwPiU1RWdpZVdoMYd5GnoKJ7bemibCfDRmGZrLvaYeN/";
    string public baseExtension = ".json";
     bool public paused = false;   
    
    constructor() ERC721A("CrazyCryptoCats", "Crazy Crypto Cats", MAX_MINTS, MAX_SUPPLY) {  
    }
