...
/**
 * @title Terrapin Universe Villains
 *
 * @notice ERC-721 NFT Token Contract
 *
 * @author 0x1687572416fdd591bcc710fa07cee94a76eea201681884b1d5cc528cba584815
 */
contract TerrapinUniverseVillains is TerrapinUniverse {
    constructor(
        TerrapinGenesis terrapinGenesis_,
        TerrapinUniverseCardPack terrapinUniverseVillainsCardPack_,
        string memory baseURI_,
        address[] memory operators
    )
        TerrapinUniverse(
            "TerrapinUniverseVillains",
            "TUV",
            terrapinGenesis_,
            terrapinUniverseVillainsCardPack_,
            baseURI_,
            operators
        )
    {}
