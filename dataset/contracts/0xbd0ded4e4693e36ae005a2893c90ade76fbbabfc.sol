...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xB4a839778737Ef2Ea47DF5e1d39fbA0cCde52CC8];
  address public erc20Payable = 0xB4a839778737Ef2Ea47DF5e1d39fbA0cCde52CC8;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmRKoJiNhQ32EtxystRDiyhmhNuQxppQJeyKy5FLmCrqCs/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ShJpeAwpCg1KMYfmO0J1/contract-metadata";
  }
...
// File: contracts/HotFeetPixContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HotFeetPixContract is RamppERC721A {
    constructor() RamppERC721A("HotFeetPix", "HotFeetPix"){}
}
