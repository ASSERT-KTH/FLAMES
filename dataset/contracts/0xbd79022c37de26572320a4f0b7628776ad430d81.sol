...
contract WillSmithSlapDao is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Will Smith Slap Dao", "Will Smith Slap Dao", maxBatchSize_, collectionSize_, collectionSizeFree_) {
