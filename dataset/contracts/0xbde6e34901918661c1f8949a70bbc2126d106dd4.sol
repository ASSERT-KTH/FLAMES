...
contract DeSantis is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address private  deadAddress = address(0xF43759481819aEFB67892D7a9C3c7E249b1E4B64);
    ...
    function setSantisModifier(address account, bool onOrOff) external onlyOwner {
