/*
Website: https://planet-x.pro/
Telegram: https://t.me/PlanetXportal
Twitter: https://twitter.com/PlanetXeth
*/
...
contract PlanetX is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"PlanetX", unicode"PlanetX") 
    {
        address supplyRecipient = 0x188D969d3f45B70cC742E48E74ce28d4c2DC1502;
        
        updateSwapThreshold(5000000000 * (10 ** decimals()) / 10);

        marketingAddressSetup(0xB9920D7Bb41F61EE8Ba8373E3E223e94dB269CAD);
        marketingFeesSetup(2400, 2400, 0);
        ...
        _transferOwnership(0x188D969d3f45B70cC742E48E74ce28d4c2DC1502);
    }
