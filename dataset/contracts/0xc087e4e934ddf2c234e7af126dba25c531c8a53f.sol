...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmUdiZTWkkN17diSvEx69FVE7pUWMuvc3WG4h8oSHbcT9S/";
...
// File: contracts/CoolCanineContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CoolCanineContract is RamppERC721A {
    constructor() RamppERC721A("Cool Canine", "COOLK9"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Pr9pvHkdSXXeGjhLIC97/contract-metadata";
    }
}
