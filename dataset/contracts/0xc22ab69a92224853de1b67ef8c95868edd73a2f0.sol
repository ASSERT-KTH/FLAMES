...
contract TokenERC20 is owned{
    ...
    string public name = "MNS COIN";
    string public symbol = 'MNSC';
    ...
    constructor(
        ...
        name = "MNS COIN";                                   // Set the name for display purposes
        symbol = "MNSC";                               // Set the symbol for display purposes
    }
...
contract MNS is owned, TokenERC20 {
