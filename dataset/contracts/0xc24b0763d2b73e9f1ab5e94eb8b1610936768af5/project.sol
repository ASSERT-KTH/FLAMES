...
contract TrianguluxbyCelestial is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 1234;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.025 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0xfd25c81c89f9910b4f8b7d53c33c7ac0b8095c65d32cbb9c222ea367f89224f1;
    bool public publicPaused = false;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmPRQjcJD1CXjoQxZrddiFdgDQRRp6jCvwzoSVuosUnbJ6";

    constructor()
        public
        ERC721A("Triangulux by Celestial", "TRIANGULUX", 1234, 1234)
    {}
