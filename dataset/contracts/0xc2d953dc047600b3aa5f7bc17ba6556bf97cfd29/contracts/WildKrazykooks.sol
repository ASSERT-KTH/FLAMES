...
contract WildKrazykooks is ERC721A, Ownable, ReentrancyGuard {
    ...
    modifier freeMintCompliance(uint256 _mintAmount) {
        ...
        require((totalFreeMinted + 1) <= freeMintLimit, "No free NFTs left.");
        _;
    }
    ...
    function getTotalFreeMinted() public view returns (uint256) {
        return totalFreeMinted;
    }
