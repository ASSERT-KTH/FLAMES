...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Genesis Bot", "GEN") {
        ...
        swapTokensAtAmount = (totalSupply * 5) / 10000; // 0.05%: 50_000

        maxTradingAmount = (totalSupply * 20) / 10000; // 0.2%: 100_000
        maxWallet = (totalSupply * 100) / 10000; // 1%: 1_000_000

        // Fee distribute
        // 20% for Liquid, 40% for Team, 40% for Rev
        liquidityFee = 200;
        revShareFee = 400;
        teamFee = 400;
        ...
        revShareWallet = 0x751F5dD416045B4D6c6274FbC124a5439c3E6b13;
