...
contract OrdinalMiniMe is ERC721A {
    string uri = "ipfs://bafybeifhj4km44h6hcma2dbnny24ws3xobbb5d4jv6zmsrhyquoqol45ri/";
    ...
    constructor() ERC721A("Ordinal Mini Me", "OMM") {
        owner = msg.sender;
        maxPerWallet = 100;
    }
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) public view virtual returns (address, uint256) {
        uint256 royaltyAmount = (_salePrice * 30) / 1000;
