...
everything else is included. It’s like the root of a tree.
All a tree’s fruit and flowers, branches and leaves depend on its root.
If you nourish its root, a tree multiplies. If you cut its root, it dies. 
...
contract Bodhidharma is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bodhidharma";
    string private _symbol = "Daijiryohitsu";
