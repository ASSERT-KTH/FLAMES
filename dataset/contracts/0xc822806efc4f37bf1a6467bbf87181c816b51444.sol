...
contract TimeLapsed is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmRHNE4q4X3RV8MSMEC44MkWew7sTXRzgnLwr5VKVbcs2M";
    ...
    constructor(
    ) ERC721A("TimeLapsed", "TL", 100, maxSupply) {
    }
