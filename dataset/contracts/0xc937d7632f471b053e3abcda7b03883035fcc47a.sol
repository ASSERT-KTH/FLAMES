...
contract Clintondigitaltradingcards is ERC721A, Ownable, OperatorFilterer {
  ...
  constructor(string memory baseURI) ERC721A("Clinton Digital Trading Cards", "CDTC") OperatorFilterer(address(OSlist), false) {
