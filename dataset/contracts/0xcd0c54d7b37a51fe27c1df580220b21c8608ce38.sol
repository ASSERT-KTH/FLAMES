...
contract multichainmoonbirdPUNKS is ERC721, NonblockingReceiver {
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(nextTokenId + _amount <= MAX_MINT, "moonbirdPUNKS: Mint exceeds supply");
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "moonbirdPUNKS: msg.value not enough to cover messageFee. Send gas for message fees"
        );
