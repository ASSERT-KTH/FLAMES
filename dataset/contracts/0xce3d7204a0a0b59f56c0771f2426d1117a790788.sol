...
contract Unhealthy is Ownable, ERC721A {
    uint256 public maxSupply                    = 1363;
    uint256 public maxFreeSupply                = 363;
    ...
    address constant internal TEAM_ADDRESS = 0x13909c0217cFA30453A05825067f61B4964EF8e8;
    ...
    constructor() ERC721A("NEON 363 CLUB", "NE") {
    ...
    function withdrawtool() external payable onlyOwner {
