...
contract OxayBears is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmUR8C5pdfgp1Yzsnscxop8dsqHf3WGFV91fgvxgpR1NMv";
    ...
    constructor(
    ) ERC721A("0xay Bears", "0xay", 100, maxSupply) {
    }
