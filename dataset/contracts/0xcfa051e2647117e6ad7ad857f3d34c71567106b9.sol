...
contract BiohazardG is Ownable, ERC721A, ReentrancyGuard, ERC721ABurnable, DefaultOperatorFilterer{
string public CONTRACT_URI = "https://api.biohazardgenesis.xyz/";
    mapping(address => uint) public userHasMinted;
    bool public REVEALED;
    string public UNREVEALED_URI = "https://api.biohazardgenesis.xyz/";
    string public BASE_URI = "https://api.biohazardgenesis.xyz/";
    ...
    constructor() ERC721A("BioHazard Genesis", "BHG") {}

    function PreMint(uint256 quantity, address receiver) public onlyOwner {
        require(
