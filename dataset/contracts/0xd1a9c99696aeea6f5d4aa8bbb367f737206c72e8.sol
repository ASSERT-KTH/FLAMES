...
contract GoblinCollective is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmYUZ88F8px2XsaXBga6Tfft2m8AFY2BVZwypMqtJeNac6";
    ...
    constructor(
    ) ERC721A("GOBLIN: Collective", "PASS", 100, maxSupply) {
    }
