...
contract MoonGhost is ERC721A, Ownable, ReentrancyGuard { 
    ...
    uint256 public _maxFreeMintSupply = 4000;

    using Strings for uint256;
    string public baseURI;
    mapping(address => uint256) private _mintedFreeAmount;

    constructor(string memory initBaseURI) ERC721A("MoonGhost ", "Ghost") {
        baseURI = initBaseURI;
    }
