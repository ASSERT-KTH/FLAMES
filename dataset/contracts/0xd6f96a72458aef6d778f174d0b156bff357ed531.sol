...
contract MetaBee is Context, IERC20, Ownable {
    ...
    string private constant _name = "MetaBee";
    ...
    address payable private _marketingAddress = payable(0xD0061A5B8fB3c1aC501E47E9f23Fe2F57CbA6537);
    ...
    uint256 public _maxTxAmount = 250000000000 * 10**9; //0.25
