...
Shinjew $JEW
Web: www.shinjew.com
telegram: t.me/Shinjew
twitter: twitter.com/Shinjew_ERC20
...
contract ShinJew is Context, IERC20Upgradeable {
    ...
    uint256 public _marketingRatio = 1300;

    uint256 private masterTaxDivisor = 10000;

    uint256 public MarketShare = 7;
    uint256 public DevShare = 6;
    uint256 public ValueDivisor = 13;
    ...
    function intializeContract(address payable setMarketWallet, address payable setDevWallet, string memory _tokenname, string memory _tokensymbol) external onlyOwner {
        ...
        _transfer(owner(), address(this),routerSupply);
...
//===============================================================================================================
    ...
    function FirstBuyandWalletLimitsIncrease() public onlyOwner() {
        _maxTxAmount = _tTotal/(1000)*(200);
        _maxWalletSize = _tTotal/(1000)*(200);
    }

    function FirstTaxLowering()
        external
        onlyOwner
    {
        _sellReflectFee = 0;
        _sellLiquidityFee = 100;
        _sellMarketingFee = 600;
        _buyReflectFee = 0;
        _buyLiquidityFee = 100;
        _buyMarketingFee = 600;
        MarketShare = 3;
        DevShare = 3;
        ValueDivisor = 6;
    }

    function SecondTaxLowering()
        external
        onlyOwner
    {
        _sellReflectFee = 0;
