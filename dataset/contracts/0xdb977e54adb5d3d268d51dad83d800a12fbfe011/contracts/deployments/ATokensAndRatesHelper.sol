...
contract ATokensAndRatesHelper is Ownable {
    ...
    address private immutable addressesProvider;
    address private immutable poolConfigurator;
    ...
    constructor(
        ...
        require(_pool != address(0), "Pool can not be zero address");
        require(
            _addressesProvider != address(0),
            "Addresses provider can not be zero address"
        );
        require(
            _poolConfigurator != address(0),
            "Pool configurator can not be zero address"
        );
        pool = _pool;
