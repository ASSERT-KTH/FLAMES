...
Official Coin of Matrix Inu

Website: http://ethmatrixinu.com/
...
contract MatrixInu is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0x176dA1F1d5aE25C22A9e077210A087b6f01E3F6a); // Marketing Wallet
    address payable private crowdfundWallet = payable(0x176dA1F1d5aE25C22A9e077210A087b6f01E3F6a); // Crowd Fund Wallet
    address payable private devWallet = payable (0x176dA1F1d5aE25C22A9e077210A087b6f01E3F6a); // Dev Wallet
    ...
    uint256 private crowdfundfee = 10;   //0% same for buys and sells
