...
contract Abstract is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmdu2kci7dFtwQwpw7To7HnL8ze1dfvUqbUcPCwLaNcWR2";
    ...
    constructor(
    ) ERC721A("Abstract by Hinote", "Abstract", 100, maxSupply) {
    }
