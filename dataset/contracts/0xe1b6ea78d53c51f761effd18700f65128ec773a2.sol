...
contract DepthsOfHell is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmYFBN3LPejJgmPZVWgELg2RPFK9A2oLvVWA1Qo7THRqNk";
    ...
    constructor(
    ) ERC721A("Monsters From Hell", "HELL", 100, maxSupply) {
    }
