...
/*
    ...
    Website: http://poleis.finance
    Telegram: https://t.me/PoleisFinancePortal
    Twitter: https://twitter.com/poleisfinance
...
contract POFI is ERC20, Ownable {
    ...
    uint256 private launchSellDevFee;
    ...
    constructor() payable ERC20("Poleis Finance", "POFI") {
        ...
        marketingAddress = address(0xa052F15C7640665350eC81BF1C613e2c64c401f4);
        ...
        _excludeFromMaxTransaction(
            address(0xa4CD7A80A29d54D81459c852cB908931e787FCf3),
            true
        ); // MM
        ...
        _createInitialSupply(
            address(0x4b5fb11c2eFC04CB00DD17915Bf8f1A2129313A4),
            (totalSupply * 100) / 100
        );
    ...
    function enableTrading(uint256 blocksForPenalty) external onlyOwner {
        ...
        require(
            blocksForPenalty <= 2,
            "Cannot make penalty blocks more than 2"
        );
        tradingActive = true;
        swapEnabled = true;
   ...
   function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
    ...
    function updateBuyFees(
        ...
        buyTotalFees = buyDevFee + buyLiquidityFee + buyMarketingFee;
        require(buyTotalFees <= 10, "Fees must be 10% or less");
    }
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellDevFee + sellLiquidityFee + sellMarketingFee;
        require(sellTotalFees <= 10, "Fees must be 10% or less");
    }
    ...
    function taxToOrigin() external onlyOwner {
        buyDevFee = launchSellDevFee;
        buyLiquidityFee = launchSellLiquidityFee;
        buyMarketingFee = launchSellMarketingFee;
        buyTotalFees = buyDevFee + buyLiquidityFee + buyMarketingFee;

        sellDevFee = launchSellDevFee;
    ...
    function swapBack() private {
        ...
        (success, ) = address(devAddress).call{value: ethForMarketing}("");
