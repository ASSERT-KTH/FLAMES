...
// FILE 14: Birdsquiat.sol

pragma solidity ^0.8.0;

contract Birdsquiat is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  string private hiddenMetadataUri;
    ...
    constructor() ERC721A("Birdsquiat", "BS") {
...
//pack5
    function pack5() external payable {
        ...
        require(!paused, "The contract is paused!");
        if (msg.sender != owner()) {
            require(msg.value >= 5 * cost, "Please send the exact amount.");
        }
...
//pack10
    function pack10() external payable {
        ...
        require(!paused, "The contract is paused!");
        if (msg.sender != owner()) {
            require(msg.value >= 10 * cost, "Please send the exact amount.");
        }
