...
Telegram Portal: https://t.me/ShibVader
Website: www.ShibVader.Space
...
contract ShibVader is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x17DD6Eba521C245c241269d8186a653aE9D71932));
    address payable public _teamwallet =
        payable(address(0x6Af3F17019677179D59D9BB5D700bA39ec1Cf8b6));
    address _partnershipswallet =
        payable(address(0x17DD6Eba521C245c241269d8186a653aE9D71932));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "Shib Vader";
    string private _symbol = "SHIBVADER";
