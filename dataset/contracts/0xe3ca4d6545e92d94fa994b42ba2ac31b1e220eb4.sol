...
contract THEInverse is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("THE Inverse", "EHT") {
        ...
        marketingWallet = address(0xCeA05ce4De1034c65820Ee43F9B530c611f4cd5e); // set as marketing wallet
        devWallet = address(0xCeA05ce4De1034c65820Ee43F9B530c611f4cd5e); // set as dev wallet
