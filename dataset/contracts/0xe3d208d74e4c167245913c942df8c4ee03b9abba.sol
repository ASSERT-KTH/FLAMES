...
contract Owned {
    ...
    constructor() public {
        owner = 0x121812BDD10F26fBe260c3eBb05731F6a679B116;
    }
...
// ----------------------------------------------------------------------------
contract Hydra is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        name = "Hydra";
        decimals = 18;
        _totalSupply = 21000000000000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
        RATE = 5260000; // 1 ETH = 526 HDA // 1 HDA = 0.380 USD
        DENOMINATOR = 10000;
