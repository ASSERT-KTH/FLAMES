...
contract Hanukkahpunks is ERC721A, Ownable, OperatorFilterer {
  ...
  constructor(string memory baseURI) ERC721A("Hanukkahpunks", "HKPK") OperatorFilterer(address(OSlist), false) {
