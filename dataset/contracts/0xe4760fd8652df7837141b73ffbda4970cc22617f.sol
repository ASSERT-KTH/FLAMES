/**
The Official Trading Competition for Degens across the World.
*/
...
contract DegenWorldCup is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DegenWorldCup", "DWC") {
        ...
        marketingWallet = address(0x2bA11046DAEC40C14f5f0bbb2a8265DA68fdCFef); // set as marketing wallet
        devWallet = address(0xd743858C1cC34Fef61f1e4492646567A2c09530a); // set as dev wallet
