...
// File: contracts/RENGABOREDCLUB.sol
...
contract RENGABOREDCLUB is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 2754;
  ...
  ) ERC721A("RENGA BORED CLUB", "RENGABC") {
