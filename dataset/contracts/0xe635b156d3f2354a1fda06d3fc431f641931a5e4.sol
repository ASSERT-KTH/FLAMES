...
contract TresorInu is ERC20, Ownable {
    ...
    constructor() ERC20("Tresor Inu", "TINU") {
        ...
        sellMarketingFee = 110;
        sellLiquidityFee = 40;
        sellStakingFee = 0;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellStakingFee;
        
    	marketingWallet = address(0x3aEB96955d3Ec04C8CcF6B0e8f880Fd5EeB73137); // set as marketing wallet
