...
MEV Repellent is a proprietary service built
to stop MEV's from FrontRunning and draining liquidity
on Zero Tax and Low Tax tokens.  Even projects who intermittently
lower taxes, benefit from our MEV Repellent.

MEV Repel will allow ALL slippage %'s without the risk
of MEV Bots stealing investor funds.

Feel free to test for yourself.

If you’re a dev and would like to inquire about adding MEV Repellant 
to your next token launch please DM @MEVrepellentDEV.
- MEV Repellent Team


https://t.me/mevrepellent
http://twitter.com/MEVrepellent
...
contract MEVREPELLENT is ERC20, Ownable {
    ...
    address public marketingWallet = 0x52c8497862E64cAfFd538B2Cec5224C4799562db;
    ...
    constructor() ERC20("MEV Repellent", "MEVREPEL") {
