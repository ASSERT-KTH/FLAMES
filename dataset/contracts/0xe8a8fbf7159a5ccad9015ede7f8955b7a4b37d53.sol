...
// File: contracts/KOKO.sol



pragma solidity ^0.8.7;

contract KOKO is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public maxPerTx = 10;
    uint256 public maxSupply = 4444;
    uint256 public freeMintMax = 4444; // Free supply
    uint256 public price = 0.004 ether;
    uint256 public maxFreePerWallet = 2; 

    string private baseURI = "https://gateway.pinata.cloud/ipfs/QmQTE2AbYNLVs6cNXupQAhdooKLY9r57TiWxS6ZiS22rCn/";
    string public notRevealedUri = "https://gateway.pinata.cloud/ipfs/QmVE3vcynmkQbMqjQKFHrQkFzPv3t6UJ5WkHsve18dDSm5/hidden.json";
    ...
    address devWallet = 0x97D52A528Be58b32BAeA83d544EA12D03509bd41;
    uint _devFee = 0;

 

    constructor() ERC721A("KOKO lost his weenie", "KOKO") {}
