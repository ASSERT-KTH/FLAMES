...
contract Goldbirds is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 5000;
    uint256 public MAX_MINTS = 5;
    string public baseURI = "ipfs://QmcmqWPmWJz97HohLSqdrC1bQbaKKy1wtu3RGhoxFAkKNw/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Goldbirds", "GOLDBRD", MAX_MINTS, MAX_SUPPLY) {  
    }
