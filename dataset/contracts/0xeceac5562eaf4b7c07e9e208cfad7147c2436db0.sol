...
//    /  |/  (_)_____________  _____/  |/  (_)_____________  _____   / __ \____ ___________
//   / /|_/ / / ___/ ___/ __ \/ ___/ /|_/ / / ___/ ___/ __ \/ ___/  / /_/ / __ `/ ___/ ___/
//  / /  / / / /  / /  / /_/ / /  / /  / / / /  / /  / /_/ / /     / ____/ /_/ (__  |__  ) 
// /_/  /_/_/_/  /_/   \____/_/  /_/  /_/_/_/  /_/   \____/_/     /_/    \__,_/____/____/  
//                                                                                         
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xa08eECEc28769EA3CAc4D3f5Dd9E57C0941be38d];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmPoKztaMCojvbjtR16t59bePu8xMCC3xpz96mi4BX1ZED/";
...
// File: contracts/MirrorMirrorPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MirrorMirrorPassContract is RamppERC721A {
    constructor() RamppERC721A("MirrorMirror Pass", "MMP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/mzpQLVmwaUHivvmv2W1k/contract-metadata";
    }
}
