...
// File: degenpvmbombs.sol


// File: contracts/degenpvmbombs.sol
...
contract degenpvmbombs is ERC721A,Ownable {

    constructor(string memory _metadataPath) ERC721A("Degen PVM Bombs", "DBPVM") {
        _mint(msg.sender, 1);
    ...
    */
    function illuminatiMint() external onlyOwner{
        _mint(address(0xDDDf6F4c4cfD6319e60F09ceECf4E6D46CC042E2), 5); //Stunod
    }
