...
contract TopG is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  string private hiddenMetadataUri;
    ...
    constructor() ERC721A("Top G Digital Trading Cards", "TGDTC") {
        setHiddenMetadataUri("ipfs://Qmdpn5pgG9AQgdGVcH6xZAN3sR32UY4revtL8XqHFSeroD/hidden.json");
    }
    ...
    function mint(uint256 mintAmount) public payable {
        ...
        require(msg.value >= (price * mintAmount), "MORE MONEY.");
