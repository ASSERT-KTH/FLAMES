...
/*
Website: https://www.triq.pro/
TG: https://t.me/TRIQeth
Twitter: https://twitter.com/TRIQeth
 */
...
contract Triq is ERC20, Ownable {
    ...
    constructor(address _developerwallet) ERC20("Triq", "TRIQ") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        LinqDividendTracker newDividendTracker = LinqDividendTracker(payable(newAddress));
...
contract LinqDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("Linq_Dividend_Tracker", "Linq_Dividend_Tracker") {}
