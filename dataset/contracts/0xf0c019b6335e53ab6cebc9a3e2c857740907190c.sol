...
contract deg3n is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmYejdidqJPupMThbFkHvyNhfmzJV7CgCSJT2LyyfVV9Kq";
    ...
    constructor(
    ) ERC721A("deg3n", "DEG3N", 100, maxSupply) {
    }
