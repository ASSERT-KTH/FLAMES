...
contract Floaties is ERC721A, Ownable {
    ...
    constructor(bytes32 merkleRoot_) ERC721A("Floaties", "FLOATIES") {
    ...
    function mintNFTWhitelist(
        ...
        uint256 mintedSoFar = whitelistMints[msg.sender] + numberOfTokens;
        require(mintedSoFar <= maxPerWhitelist, "You can't mint that many");

        whitelistMints[msg.sender] = mintedSoFar;
    ...
    function sendPayouts() public onlyOwner {
        uint256 payout = (address(this).balance * 70) / 100;

        uint256 dev = (payout * 1950) / 10000;
        uint256 art = (payout * 1750) / 10000;
        uint256 copy = (payout * 1750) / 10000;
        uint256 idea = (payout * 1750) / 10000;
        uint256 lowiq = (payout * 1000) / 10000;
        uint256 mkt = (payout * 1800) / 10000;
