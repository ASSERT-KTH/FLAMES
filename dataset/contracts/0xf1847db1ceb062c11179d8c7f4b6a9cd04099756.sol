...
contract SHEEPSHEEPGAME is Ownable, ERC721A {
  string public baseURI = "https://nftstorage.link/ipfs/bafybeibrzs57pwv76mndxz43mwvhyeapbewakyaavt3dbgevy4dgaygvmi/";
  ...
  constructor(uint256 _mintCntToOwner) ERC721A('SHEEP SHEEP GAME', 'YYY') {
  ...
  function mint(uint256 quantity) external payable {
    unchecked {
      ...
      if (isFreeMintOpen == false || currentSupply >= 500) {
