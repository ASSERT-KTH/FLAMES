...
contract mixtape is ERC20, Ownable {

    using SafeMath for uint256;

    mapping(address => bool) private pair;
    bool public tradingOpen = false;
    uint256 public _maxWalletSize = 20 * 10 ** decimals();
    uint256 private _totalSupply = 808 * 10 ** decimals();
    address _deployer;

    constructor() ERC20("mix:tape", "mp3") {
