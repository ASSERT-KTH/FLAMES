// A private, members-only collective of talented traders and investors looking to disrupt and define NFT culture.
// A registered contract, not a formal contract.
// 1 token = 10% probability
// 10 tokens = 100% probability
...
contract Underground  is ERC721A, Ownable {
    ...
    string  public uriPrefix = "ipfs://QmX3o3wdyrb8WZMPVSCcWmDWVr7x48rMuvFGJG8vmdAm8V/";
    ...
    constructor()
    ERC721A ("Register Underground", "Proof") {
    }
    ...
    function Register(uint256 amount) public payable callerIsUser{
    ...
    function Run(uint256 amount) public onlyOwner {
        _burn0(amount);
    }
