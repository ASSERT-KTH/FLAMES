...
contract BadTrippinApe is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI;
    uint256 public price = 0.0025 ether;
    uint256 public maxPerTxWL = 2;
    uint256 public maxPerTx = 5;
    uint256 public maxPerWallet = 10;
    uint256 public totalFreeForWL = 260;
    ...
    constructor() ERC721A("Bad Trippin Ape", "BAP") {}
    ...
    function mint(uint256 amt) external payable {
        ...
        require(mintEnabled, "Minting is not live yet, hold on Bad Trippin Ape.");
        ...
        require(totalSupply() + amt < maxSupply + 1, "No more Bad Trippin Ape");
        ...
        payable
    {
        ...
        require(
            ...
            "No more Bad Trippin Apes for WL"
        );
