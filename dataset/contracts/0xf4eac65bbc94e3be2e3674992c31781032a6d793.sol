...
//*********************************************************************//
//
//  _________  __              _____  _____   ______    ______  
// |  _   _  |[  |            |_   _||_   _|.' ___  | .' ___  | 
// |_/ | | \_| | |--.  .---.    | |    | | / .'   \_|/ .'   \_| 
//     | |     | .-. |/ /__\\   | '    ' | | |       | |        
//    _| |_    | | | || \__.,    \ \__/ /  \ `.___.'\\ `.___.'\ 
//   |_____|  [___]|__]'.__.'     `.__.'    `.____ .' `.____ .' 
//                                                              
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x7AA0F5c54c1c52745E1ddc34DB82ee7FA816B6C3];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmUcEnG6qb1p1yTFfcoTgCiZy64KKR596CfCnKAtQ3hZsR/";
...
// File: contracts/TheUncannyCountryClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheUncannyCountryClubContract is RamppERC721A {
    constructor() RamppERC721A("The Uncanny Country Club", "RAMPP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/51Otsvf44EbcBCFjVodt/contract-metadata";
    }
}
