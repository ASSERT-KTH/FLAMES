...
// File contracts/Spaceguins.sol
// Build by @realCodeCraft :)
pragma solidity 0.8.9;

contract MechaPilotsSpaceguins is ERC721Delegated {
    uint256 public reserveTokenId = 0;
    bool public sale = false;

    uint256 public MAX_SUPPLY = 250;

    bytes32 public merkleRoot = 0xd348e75d89079d1242c9cb2e8b5521aed1092edc99790502316d7ffe7c5d9080;
    ...
    function claim(bytes32[] calldata _merkleProof) public {
        ...
        require(reserveTokenId + 1 <= MAX_SUPPLY, "Sold Out");
