...
contract DODO is ERC20, Ownable {
    ...
    constructor() ERC20("DODO", "DODO") payable {
    	...
    	marketingWallet = address(0x292c8c9335749D569EeE588452b1F26daD748dE3); // set as Marketing wallet
        devWallet = address(0x442FF6241dDe3A9cdC85e5B5E0F00E272c841024); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x292c8c9335749D569EeE588452b1F26daD748dE3, true);
        excludeFromFees(0x442FF6241dDe3A9cdC85e5B5E0F00E272c841024, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x292c8c9335749D569EeE588452b1F26daD748dE3, true);
        excludeFromMaxTransaction(0x442FF6241dDe3A9cdC85e5B5E0F00E272c841024, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x442FF6241dDe3A9cdC85e5B5E0F00E272c841024,
            block.timestamp
        );
    }
