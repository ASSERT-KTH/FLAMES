...
contract HeiTuZi is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Hei Tuzi"; 
    string private constant _symbol = "$HTuZi"; 
    ...
    address payable private _developmentWalletAddress = payable(0xd1242D27BE371d09Ac59F5e572D52d836E188624);
    address payable private _marketingWalletAddress = payable(0x4099610F79c75263bEfDb1394CEd9B9550FF90C2);
