...
contract WC is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmXEZPdv6A3jKWT1oj8DatkyWSP76XSubA4RQ7MikuTZ8u";
    ...
    constructor() ERC721A("We Are Crazy", "WC"){}
    ...
    function mint(uint256 count) external payable {
        ...
        require(!paused, "The contract is paused!");
        require(msg.value >= count * cost, "Send the exact amount: 0.003*(count)");
        require(totalSupply() + count <= maxSupply, "No more.");
        require(count <= maxPerTx, "Max per TX reached.");
        }
