...
contract KangafuFighters is ERC721A, Ownable {
    
    uint256 MAX_SUPPLY = 6666;
    uint256 Allremain = 6666;
    uint256 public mintRate = 0.005 ether; 
    uint256 MintForWallet = 6666;
    string public base_URI = "";
    string public baseExtension = ".json";
    string public prerevealURL = "ipfs://__CID__/hidden.json" ;
    bool public start = true;
 
    mapping (address => uint256) private MintedBalance;

    constructor() ERC721A("KangafuFighters", "KANGAFU") {}
    ...
    function mint(uint256 quantity) public payable {
        ...
        require(quantity<=6 , "Sorry, there are only 6 items allowed for each minting.");
