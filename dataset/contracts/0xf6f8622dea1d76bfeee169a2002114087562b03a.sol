...
contract LuxAeternaMetallica is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("Metallica: Lux Aeterna", "AETERNA")
    {
        baseURI = _baseURI;
