 ...
 ,;           |=".-_,:;'-,"        ;.         ;,      ( / // // // /
  ...
  `.==--._ \\ \\ \\ \".`./;./       ". \\ \\ \\ \ \
          ...
          (_/"./`,/;./                `,.\\ \\ \\,\
            ...
            https://medium.com/@tsukuyominomikoto66/apotheosis-68bfe4272aef
...
contract TSUKU is ERC20, Ownable {
    ...
    constructor() ERC20("Tsukuyomi-No-Mikoto", "$TSUKU") {
		...
		charityWallet = address(0xc3a1e861802134CbFC74c9Af323488DE60B93ded); // set as charity wallet
        marketingWallet = address(0xc3a1e861802134CbFC74c9Af323488DE60B93ded); // set as marketing wallet
        devWallet = address(0xc3a1e861802134CbFC74c9Af323488DE60B93ded); // set as dev wallet
