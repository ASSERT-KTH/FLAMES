/**
    ...
    ___                       
       _(((,|    Do you have the $APEGENE within?     
      /  _-\\                  www.ApeGene.com                   
     / C o\o \                  Telegram: T.me/ApeGene   
...
contract ApeGene is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ApeGene", "APEGENE") {
        ...
        marketingWallet = address(0xC1fb4Da07Cc59db13321C857A7Bf93c40949fD2f); // set as marketing wallet
        devWallet = address(0x02A466f38546f4550c15e2ee83aA6a5290a0e8F4); // set as dev wallet
