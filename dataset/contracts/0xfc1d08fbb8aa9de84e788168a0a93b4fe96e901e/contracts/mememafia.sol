...
contract MemeMafia is Context, IERC20, Ownable {
    ...
    string private constant _name = "Meme Mafia";
    string private constant _symbol = "MEMEMAFIA";
    uint256 public _maxTxAmount = 5_000_001 * 10**_decimals; //.5% @1B -Set to Total Supply shortly after launch(100%)
    uint256 public _maxWalletSize = 50_000_001 * 10**_decimals; // 5% @1B- Set to Total Supply shortly after launch (100%)
    uint256 public _taxSwap = 5_000_000 * 10**_decimals; //auto swap and liquify when contract holds .5% of supply
