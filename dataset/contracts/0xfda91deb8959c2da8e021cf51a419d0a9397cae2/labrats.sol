...
contract Labrats is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string _baseTokenURI;

    address addr_1 = 0x0a2f65DEF20B868D23Ba7cF1DA40424CFB1ae080;
    ...
    constructor(string memory baseURI) ERC721("Labrats", "LABRATS")  {
        setBaseURI(baseURI);
    }
