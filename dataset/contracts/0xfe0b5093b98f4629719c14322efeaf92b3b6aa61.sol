...
contract ModernSinCity is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("Modern Sin City ", "MSC") {
        setHiddenMetadataUri("ipfs://QmQDtgkhy89nJjryLpQxdFzutVfA2NsSkK2Myi2SNggWYF//");
        setBaseURI("ipfs://QmQDtgkhy89nJjryLpQxdFzutVfA2NsSkK2Myi2SNggWYF//");
    }
    ...
    function mint(uint256 count) external payable {
      ...
      require(totalSupply() + count <= maxSupply, "No more MSC");
