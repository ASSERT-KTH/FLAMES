...
contract zsToken is ERC20("Stabilize Strategy Multi-Seigniorage", "zs-SGR"), Ownable, ReentrancyGuard {
    ...
    // Token information
    // This wrapped token accepts multiple sgr coins
    // ESD, DSD, BAC
    struct TokenInfo {
