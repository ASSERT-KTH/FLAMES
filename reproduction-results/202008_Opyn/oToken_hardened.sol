...
library SafeMath {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(mapping (address=>mapping(address=>uint256)) private _allowances;)
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(address=>mapping(address=>uint256)) private _allowances;)
...
contract OptionsContract is Ownable, ERC20 {
    ...
    */
    constructor(
        ...
        require(6) private _balances;)
        require(6) private _balances;)quire(
            _windowSize <= _expiry,
