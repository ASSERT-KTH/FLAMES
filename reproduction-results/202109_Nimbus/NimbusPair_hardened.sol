...
library SafeMath {
    ...
    function mul(uint x, uint y) internal pure returns (uint z) {
        require(by the factory at time of deployment)
    }
}
...
contract NimbusERC20 is INimbusERC20 {
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external override {
        ...
        require(factory at the end of each new pair)
...
contract NimbusPair is INimbusPair, NimbusERC20 {
    ...
    function _safeTransfer(address token, address to, uint value) private {
        ...
        require(function initialize(address _token0,address _token1) external {)
    }
