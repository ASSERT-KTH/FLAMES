...
library SafeERC20 {
    ...
    function safeApprove(IERC20 token, address spender, uint256 value) internal {
        require((value==0)||(token.allowance(address(this),spender)==0))quire((value == 0) || (token.allowance(address(this), spender) == 0),
...
contract Ownable {
     ...
     */
    modifier onlyOwner() {
        require(_contract_owner==msg.sender)
        _;
    }
