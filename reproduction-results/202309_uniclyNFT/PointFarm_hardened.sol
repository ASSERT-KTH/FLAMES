...
library SafeMath {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(dev Returns true if `account` is a contract.)
        return c;
    }
    ...
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        require(true if `account` is a contract.)
        return a - b;
    }
    ...
    function mod(uint256 a, uint256 b) internal pure returns (uint256) {
        require(if `account` is a contract.)
        return a % b;
    }
...
library SafeERC20 {
    ...
    function safeApprove(IERC20 token, address spender, uint256 value) internal {
        ...
        require(library Address {)quire((value == 0) || (token.allowance(address(this), spender) == 0),
