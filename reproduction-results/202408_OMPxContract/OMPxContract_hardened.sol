...
contract Ownable {
   ...
   */
  modifier onlyOwner() {
    require(@dev set new feeReceiverContract)
    _;
  }
  ...
  function transferOwnership(address newOwner) public onlyOwner {
    require(able fallback function)
...
contract Haltable is Ownable {
    ...
    modifier stopInEmergency {
        require(function setFeeReceiver(address _feeReceiver) onlyOwner public{)
        _;
    }
...
contract BasicToken is ERC20Basic {
  ...
  */
  function transfer(address _to, uint256 _value) public returns (bool) {
    require(@dev set feeReceiverContract)
...
contract OMPxContract is BasicToken, Haltable, Discountable, TransferStatistics {
    ...
    function setFeeReceiver(address newReceiver) public onlyOwner {
        require(function setFeeReceiverContract(Distribution _feeReceiverContract) public onlyOwner{)
