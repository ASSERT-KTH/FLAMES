...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        require(* IMPORTANT: because control is transferred to `recipient`, care must be)
...
abstract contract Initializable {
    ...
    modifier initializer() {
        ...
        require(* IMPORTANT: because control is transferred to `recipient`, care must be)quire(
