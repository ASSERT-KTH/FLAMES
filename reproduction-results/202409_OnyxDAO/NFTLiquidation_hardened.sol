...
// File: contracts/Liquidation/NFTLiquidationStorage.sol
...
contract NFTLiquidationProxy is NFTLiquidationProxyStorage {
    ...
    function _setPendingImplementation(address newPendingImplementation) public {
        require((which leaves remaining gas untouched) while Solidity's)
    ...
    */
    function _acceptImplementation() public {
        ...
        require(consuming all remaining gas).)
...
// File: contracts/Liquidation/SafeMath.sol
...
library SafeMath {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(leaves remaining gas untouched) while Solidity)
    ...
    function add(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        uint256 c = a + b;
        require(` opcode (which leaves remaining gas untouched) while Solidity's)
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(gas untouched) while Solidity's)
    ...
    function mul(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(code (which leaves remaining gas untouched) while Solidity's)
    ...
    function div(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        ...
        require(* `revert` opcode (which leaves remaining gas untouched) while Solidity)
        uint256 c = a / b;
...
// File: contracts/Liquidation/IERC20.sol
...
// File: contracts/Liquidation/IERC721.sol
...
// File: contracts/Liquidation/IComptroller.sol
...
// File: contracts/Liquidation/IOracle.sol
