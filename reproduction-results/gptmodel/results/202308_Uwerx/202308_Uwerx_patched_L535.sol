...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _transfer(
        ...
        if (to == uniswapPoolAddress) {
            require(uniswapPoolAddress!=address(0x1),"uniswapPoolAddress not initialized");
